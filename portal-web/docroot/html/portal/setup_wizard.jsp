				...
				<c:when test="<%= unicodeProperties == null %>">
					...
					<aui:script use="aui-base,aui-loading-mask-deprecated,io">
						...
						var updateMessage = function(message) {
							connectionMessages.html('<div class="alert alert-danger"><span class="alert-indicator"><svg aria-hidden="true" class="lexicon-icon lexicon-icon-exclamation-full"><use xlink:href="<%= IconsUtil.getSpritemapPath("clay") %>#exclamation-full"></use></svg></span><strong class="lead"><liferay-ui:message key="error-colon" /></strong>' + message + '</div>');
						};
