...
public class PortletItemUtil {
	 ...
	 */
	public static Map<Serializable, PortletItem> fetchByPrimaryKeys(
	 ...
	 */
	public static PortletItem update(
		PortletItem portletItem, ServiceContext serviceContext) {
	 ...
	 */
	public static PortletItem findByG_C_First(
	 ...
	 */
	public static PortletItem fetchByG_C_First(
		long groupId, long classNameId,
		OrderByComparator<PortletItem> orderByComparator) {
	...
	public static List<PortletItem> findByG_P_C(
		...
		return getPersistence().findByG_P_C(
			groupId, portletId, classNameId, start, end);
	}
	 ...
	 * @throws NoSuchPortletItemException if a matching portlet item could not be found
	 */
	public static PortletItem findByG_P_C_First(
			long groupId, String portletId, long classNameId,
			OrderByComparator<PortletItem> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchPortletItemException {
	 ...
	 * @throws NoSuchPortletItemException if a matching portlet item could not be found
	 */
	public static PortletItem findByG_N_P_C(
			long groupId, String name, String portletId, long classNameId)
		throws com.liferay.portal.kernel.exception.NoSuchPortletItemException {

		return getPersistence().findByG_N_P_C(
	 ...
	 */
	public static PortletItem removeByG_N_P_C(
			long groupId, String name, String portletId, long classNameId)
		throws com.liferay.portal.kernel.exception.NoSuchPortletItemException {

		return getPersistence().removeByG_N_P_C(
			groupId, name, portletId, classNameId);
	}
	 ...
	 * @return the number of matching portlet items
	 */
	public static int countByG_N_P_C(
		long groupId, String name, String portletId, long classNameId) {

		return getPersistence().countByG_N_P_C(
			groupId, name, portletId, classNameId);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:1982775411