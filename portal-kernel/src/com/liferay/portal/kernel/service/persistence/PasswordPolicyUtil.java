...
/**
 * The persistence utility for the password policy service. This utility wraps <code>com.liferay.portal.service.persistence.impl.PasswordPolicyPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PasswordPolicyUtil {
	 ...
	 */
	public static Map<Serializable, PasswordPolicy> fetchByPrimaryKeys(
	 ...
	 */
	public static PasswordPolicy update(
		PasswordPolicy passwordPolicy, ServiceContext serviceContext) {
	 ...
	 */
	public static PasswordPolicy findByUuid_First(
	 ...
	 */
	public static PasswordPolicy fetchByUuid_First(
		String uuid, OrderByComparator<PasswordPolicy> orderByComparator) {
	 ...
	 */
	public static List<PasswordPolicy> filterFindByUuid(
		String uuid, int start, int end) {
	 ...
	 * @throws NoSuchPasswordPolicyException if a matching password policy could not be found
	 */
	public static PasswordPolicy findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<PasswordPolicy> orderByComparator)
		throws com.liferay.portal.kernel.exception.
			NoSuchPasswordPolicyException {
	 ...
	 * @return the first matching password policy, or <code>null</code> if a matching password policy could not be found
	 */
	public static PasswordPolicy fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<PasswordPolicy> orderByComparator) {
	 ...
	 * @throws NoSuchPasswordPolicyException if a matching password policy could not be found
	 */
	public static PasswordPolicy findByCompanyId_First(
	 ...
	 * @return the first matching password policy, or <code>null</code> if a matching password policy could not be found
	 */
	public static PasswordPolicy fetchByCompanyId_First(
		long companyId, OrderByComparator<PasswordPolicy> orderByComparator) {
	 ...
	 * @return the range of matching password policies that the user has permission to view
	 */
	public static List<PasswordPolicy> filterFindByCompanyId(
		long companyId, int start, int end) {
	 ...
	 * @throws NoSuchPasswordPolicyException if a matching password policy could not be found
	 */
	public static PasswordPolicy findByC_N(long companyId, String name)
		throws com.liferay.portal.kernel.exception.
			NoSuchPasswordPolicyException {
	 ...
	 */
	public static PasswordPolicy removeByC_N(long companyId, String name)
		throws com.liferay.portal.kernel.exception.
			NoSuchPasswordPolicyException {
...
// LIFERAY-SERVICE-BUILDER-HASH:1180446798