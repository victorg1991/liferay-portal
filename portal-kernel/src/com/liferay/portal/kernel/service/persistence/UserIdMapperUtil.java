...
public class UserIdMapperUtil {
	 ...
	 */
	public static Map<Serializable, UserIdMapper> fetchByPrimaryKeys(
	 ...
	 */
	public static UserIdMapper update(
		UserIdMapper userIdMapper, ServiceContext serviceContext) {
	 ...
	 */
	public static UserIdMapper findByUserId_First(
	 ...
	 */
	public static UserIdMapper fetchByUserId_First(
		long userId, OrderByComparator<UserIdMapper> orderByComparator) {
