...
/**
 * The persistence utility for the layout set prototype service. This utility wraps <code>com.liferay.portal.service.persistence.impl.LayoutSetPrototypePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class LayoutSetPrototypeUtil {
	 ...
	 */
	public static Map<Serializable, LayoutSetPrototype> fetchByPrimaryKeys(
	 ...
	 */
	public static List<LayoutSetPrototype> findByUuid(
	 ...
	 */
	public static LayoutSetPrototype findByUuid_First(
			String uuid,
			OrderByComparator<LayoutSetPrototype> orderByComparator)
	 ...
	 */
	public static LayoutSetPrototype fetchByUuid_First(
	 ...
	 * @return the matching layout set prototypes
	 */
	public static List<LayoutSetPrototype> findByUuid_C(
	 ...
	 * @throws NoSuchLayoutSetPrototypeException if a matching layout set prototype could not be found
	 */
	public static LayoutSetPrototype findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<LayoutSetPrototype> orderByComparator)
		throws com.liferay.portal.kernel.exception.
			NoSuchLayoutSetPrototypeException {
	 ...
	 * @return the range of matching layout set prototypes
	 */
	public static List<LayoutSetPrototype> findByCompanyId(
	 ...
	 * @throws NoSuchLayoutSetPrototypeException if a matching layout set prototype could not be found
	 */
	public static LayoutSetPrototype findByCompanyId_First(
			long companyId,
			OrderByComparator<LayoutSetPrototype> orderByComparator)
		throws com.liferay.portal.kernel.exception.
			NoSuchLayoutSetPrototypeException {
	 ...
	 * @return the first matching layout set prototype, or <code>null</code> if a matching layout set prototype could not be found
	 */
	public static LayoutSetPrototype fetchByCompanyId_First(
		long companyId,
		OrderByComparator<LayoutSetPrototype> orderByComparator) {
	 ...
	 * @return the matching layout set prototypes
	 */
	public static List<LayoutSetPrototype> findByC_A(
	 ...
	 * @throws NoSuchLayoutSetPrototypeException if a matching layout set prototype could not be found
	 */
	public static LayoutSetPrototype findByC_A_First(
			long companyId, boolean active,
			OrderByComparator<LayoutSetPrototype> orderByComparator)
		throws com.liferay.portal.kernel.exception.
			NoSuchLayoutSetPrototypeException {
	 ...
	 * @return the first matching layout set prototype, or <code>null</code> if a matching layout set prototype could not be found
	 */
	public static LayoutSetPrototype fetchByC_A_First(
		long companyId, boolean active,
		OrderByComparator<LayoutSetPrototype> orderByComparator) {
	 ...
	 * @return the matching layout set prototypes that the user has permission to view
	 */
	public static List<LayoutSetPrototype> filterFindByC_A(
		long companyId, boolean active) {
...
// LIFERAY-SERVICE-BUILDER-HASH:-779271898