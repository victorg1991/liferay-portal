...
/**
 * The persistence utility for the membership request service. This utility wraps <code>com.liferay.portal.service.persistence.impl.MembershipRequestPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class MembershipRequestUtil {
	 ...
	 */
	public static Map<Serializable, MembershipRequest> fetchByPrimaryKeys(
	 ...
	 */
	public static List<MembershipRequest> findByGroupId(
	 ...
	 */
	public static MembershipRequest findByGroupId_First(
			long groupId,
			OrderByComparator<MembershipRequest> orderByComparator)
	 ...
	 */
	public static MembershipRequest fetchByGroupId_First(
	 ...
	 * @return the range of matching membership requests
	 */
	public static List<MembershipRequest> findByUserId(
	 ...
	 * @throws NoSuchMembershipRequestException if a matching membership request could not be found
	 */
	public static MembershipRequest findByUserId_First(
	 ...
	 * @return the first matching membership request, or <code>null</code> if a matching membership request could not be found
	 */
	public static MembershipRequest fetchByUserId_First(
		long userId, OrderByComparator<MembershipRequest> orderByComparator) {
	 ...
	 * @return the matching membership requests
	 */
	public static List<MembershipRequest> findByG_S(
	 ...
	 * @throws NoSuchMembershipRequestException if a matching membership request could not be found
	 */
	public static MembershipRequest findByG_S_First(
			long groupId, long statusId,
			OrderByComparator<MembershipRequest> orderByComparator)
		throws com.liferay.portal.kernel.exception.
			NoSuchMembershipRequestException {
	 ...
	 * @return the first matching membership request, or <code>null</code> if a matching membership request could not be found
	 */
	public static MembershipRequest fetchByG_S_First(
		long groupId, long statusId,
		OrderByComparator<MembershipRequest> orderByComparator) {
	 ...
	 * @return the matching membership requests
	 */
	public static List<MembershipRequest> findByG_U_S(
	...
	public static List<MembershipRequest> findByG_U_S(
		...
		return getPersistence().findByG_U_S(
			groupId, userId, statusId, start, end);
	}
	 ...
	 * @throws NoSuchMembershipRequestException if a matching membership request could not be found
	 */
	public static MembershipRequest findByG_U_S_First(
			long groupId, long userId, long statusId,
			OrderByComparator<MembershipRequest> orderByComparator)
		throws com.liferay.portal.kernel.exception.
			NoSuchMembershipRequestException {
	 ...
	 * @return the first matching membership request, or <code>null</code> if a matching membership request could not be found
	 */
	public static MembershipRequest fetchByG_U_S_First(
		long groupId, long userId, long statusId,
		OrderByComparator<MembershipRequest> orderByComparator) {
	 ...
	 */
	public static MembershipRequest fetchByPrimaryKey(
