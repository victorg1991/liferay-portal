...
/**
 * The persistence utility for the social activity counter service. This utility wraps <code>com.liferay.portlet.social.service.persistence.impl.SocialActivityCounterPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class SocialActivityCounterUtil {
	 ...
	 */
	public static Map<Serializable, SocialActivityCounter> fetchByPrimaryKeys(
	 ...
	 */
	public static List<SocialActivityCounter> findByGroupId(
	 ...
	 */
	public static SocialActivityCounter findByGroupId_First(
			long groupId,
			OrderByComparator<SocialActivityCounter> orderByComparator)
	 ...
	 */
	public static SocialActivityCounter fetchByGroupId_First(
		long groupId,
		OrderByComparator<SocialActivityCounter> orderByComparator) {
	 ...
	 * @return the matching social activity counters
	 */
	public static List<SocialActivityCounter> findByC_C(
	 ...
	 * @throws NoSuchActivityCounterException if a matching social activity counter could not be found
	 */
	public static SocialActivityCounter findByC_C_First(
			long classNameId, long classPK,
			OrderByComparator<SocialActivityCounter> orderByComparator)
		throws com.liferay.social.kernel.exception.
			NoSuchActivityCounterException {
	 ...
	 * @return the first matching social activity counter, or <code>null</code> if a matching social activity counter could not be found
	 */
	public static SocialActivityCounter fetchByC_C_First(
		long classNameId, long classPK,
		OrderByComparator<SocialActivityCounter> orderByComparator) {
	 ...
	 * @return the matching social activity counters
	 */
	public static List<SocialActivityCounter> findByG_C_C_O(
		long groupId, long classNameId, long classPK, int ownerType) {

		return getPersistence().findByG_C_C_O(
	 ...
	 * @throws NoSuchActivityCounterException if a matching social activity counter could not be found
	 */
	public static SocialActivityCounter findByG_C_C_O_First(
			long groupId, long classNameId, long classPK, int ownerType,
			OrderByComparator<SocialActivityCounter> orderByComparator)
		throws com.liferay.social.kernel.exception.
			NoSuchActivityCounterException {

		return getPersistence().findByG_C_C_O_First(
	 ...
	 * @return the first matching social activity counter, or <code>null</code> if a matching social activity counter could not be found
	 */
	public static SocialActivityCounter fetchByG_C_C_O_First(
		long groupId, long classNameId, long classPK, int ownerType,
		OrderByComparator<SocialActivityCounter> orderByComparator) {

		return getPersistence().fetchByG_C_C_O_First(
			groupId, classNameId, classPK, ownerType, orderByComparator);
	}
	 ...
	 * @param ownerType the owner type
	 */
	public static void removeByG_C_C_O(
		long groupId, long classNameId, long classPK, int ownerType) {

		getPersistence().removeByG_C_C_O(
			groupId, classNameId, classPK, ownerType);
	}
	 ...
	 * @return the number of matching social activity counters
	 */
	public static int countByG_C_C_O(
		long groupId, long classNameId, long classPK, int ownerType) {

		return getPersistence().countByG_C_C_O(
			groupId, classNameId, classPK, ownerType);
	}
	 ...
	 * @throws NoSuchActivityCounterException if a matching social activity counter could not be found
	 */
	public static SocialActivityCounter findByG_C_C_N_O_S(
			long groupId, long classNameId, long classPK, String name,
			int ownerType, int startPeriod)
		throws com.liferay.social.kernel.exception.
			NoSuchActivityCounterException {

		return getPersistence().findByG_C_C_N_O_S(
	 ...
	 */
	public static SocialActivityCounter fetchByG_C_C_N_O_S(
		long groupId, long classNameId, long classPK, String name,
		int ownerType, int startPeriod) {

		return getPersistence().fetchByG_C_C_N_O_S(
			groupId, classNameId, classPK, name, ownerType, startPeriod);
	}
	 ...
	 */
	public static SocialActivityCounter removeByG_C_C_N_O_S(
			long groupId, long classNameId, long classPK, String name,
			int ownerType, int startPeriod)
		throws com.liferay.social.kernel.exception.
			NoSuchActivityCounterException {

		return getPersistence().removeByG_C_C_N_O_S(
			groupId, classNameId, classPK, name, ownerType, startPeriod);
	}
	 ...
	 * @return the number of matching social activity counters
	 */
	public static int countByG_C_C_N_O_S(
		long groupId, long classNameId, long classPK, String name,
		int ownerType, int startPeriod) {

		return getPersistence().countByG_C_C_N_O_S(
			groupId, classNameId, classPK, name, ownerType, startPeriod);
	}
	 ...
	 * @throws NoSuchActivityCounterException if a matching social activity counter could not be found
	 */
	public static SocialActivityCounter findByG_C_C_N_O_E(
			long groupId, long classNameId, long classPK, String name,
			int ownerType, int endPeriod)
		throws com.liferay.social.kernel.exception.
			NoSuchActivityCounterException {

		return getPersistence().findByG_C_C_N_O_E(
	 ...
	 * @return the matching social activity counter, or <code>null</code> if a matching social activity counter could not be found
	 */
	public static SocialActivityCounter fetchByG_C_C_N_O_E(
		long groupId, long classNameId, long classPK, String name,
		int ownerType, int endPeriod) {

		return getPersistence().fetchByG_C_C_N_O_E(
			groupId, classNameId, classPK, name, ownerType, endPeriod);
	}
	 ...
	 * @return the social activity counter that was removed
	 */
	public static SocialActivityCounter removeByG_C_C_N_O_E(
			long groupId, long classNameId, long classPK, String name,
			int ownerType, int endPeriod)
		throws com.liferay.social.kernel.exception.
			NoSuchActivityCounterException {

		return getPersistence().removeByG_C_C_N_O_E(
			groupId, classNameId, classPK, name, ownerType, endPeriod);
	}
	...
	public static int countByG_C_C_N_O_E(
		...
		return getPersistence().countByG_C_C_N_O_E(
			groupId, classNameId, classPK, name, ownerType, endPeriod);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-1546485147