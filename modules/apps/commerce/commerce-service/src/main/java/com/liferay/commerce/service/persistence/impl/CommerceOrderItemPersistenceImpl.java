...
public class CommerceOrderItemPersistenceImpl
	...
	public CommerceOrderItem fetchByCommerceInventoryBookedQuantityId_First(
		...
		List<CommerceOrderItem> list = findByCommerceInventoryBookedQuantityId(
			commerceInventoryBookedQuantityId, 0, 1, orderByComparator);
	...
	public CommerceOrderItem fetchByCommerceInventoryBookedQuantityId_Last(
		...
		int count = countByCommerceInventoryBookedQuantityId(
		...
		List<CommerceOrderItem> list = findByCommerceInventoryBookedQuantityId(
			commerceInventoryBookedQuantityId, count - 1, count,
			orderByComparator);
	...
	public CommerceOrderItem[]
		...
		try {
			...
			array[0] = getByCommerceInventoryBookedQuantityId_PrevAndNext(
				session, commerceOrderItem, commerceInventoryBookedQuantityId,
				orderByComparator, true);

			array[1] = commerceOrderItem;

			array[2] = getByCommerceInventoryBookedQuantityId_PrevAndNext(
				session, commerceOrderItem, commerceInventoryBookedQuantityId,
	...
	protected CommerceOrderItem
		getByCommerceInventoryBookedQuantityId_PrevAndNext(
