...
public class Account implements Serializable {
	...
	@DecimalMin("0")
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Internal long ID of the linked account; read-only.",
		example = "30130"
	)
	public Long getId() {
		if (_idSupplier != null) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Display name of the linked account; read-only.",
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.commerce.admin.channel.dto.v1_0.Account",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-965327260