...
public class DefaultCategoryDisplayPage implements Serializable {
	...
	public static DefaultCategoryDisplayPage toDTO(String json) {
		return ObjectMapperUtil.readValue(
			DefaultCategoryDisplayPage.class, json);
	}

	public static DefaultCategoryDisplayPage unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.commerce.admin.channel.dto.v1_0.DefaultCategoryDisplayPage",
		name = "x-class-name"
	)
