...
@Generated("")
@GraphQLName(
	description = "Generic error response body returned by the portal framework when a catalog request fails; read-only and emitted by the platform rather than declared by this module.",
	value = "Error"
)
...
public class Error implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Internal numeric code that classifies the error category; required and read-only.",
		example = "996"
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Human-readable description of the failure, suitable for displaying to API clients; required and read-only.",
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Technical detail message, often including the underlying failure text; required and read-only.",
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "HTTP status code of the response; required and read-only.",
		example = "404"
	)
...
// LIFERAY-REST-BUILDER-HASH:-533033868