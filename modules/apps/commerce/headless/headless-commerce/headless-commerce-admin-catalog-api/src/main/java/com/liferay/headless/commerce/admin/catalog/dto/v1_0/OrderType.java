...
public class OrderType implements Serializable {
	...
	@DecimalMin("0")
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Reference to the order type (FK identifier); read-only in this module.",
		example = "30130"
	)
	public Long getId() {
		if (_idSupplier != null) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.commerce.admin.catalog.dto.v1_0.OrderType",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1397237240