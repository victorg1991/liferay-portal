...
public class ProductConfigurationListOrderType implements Serializable {
	...
	public Long getProductConfigurationListOrderTypeId() {
		if (_productConfigurationListOrderTypeIdSupplier != null) {
			productConfigurationListOrderTypeId =
				_productConfigurationListOrderTypeIdSupplier.get();

			_productConfigurationListOrderTypeIdSupplier = null;
		}
	...
	public void setProductConfigurationListOrderTypeId(
		...
		_productConfigurationListOrderTypeIdSupplier = () -> {
			try {
				return productConfigurationListOrderTypeIdUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<Long> _productConfigurationListOrderTypeIdSupplier;
	...
	public String toString() {
		...
		if (productConfigurationListOrderTypeId != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
...
// LIFERAY-REST-BUILDER-HASH:384331842