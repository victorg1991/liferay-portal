...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Channel.DisplayPageExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class DisplayPageExceptionMapper
	extends BaseExceptionMapper<CPDisplayLayoutEntryException> {
