...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Channel.ChannelAccountStatusExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class ChannelAccountStatusExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(
			...
			_language.get(
				...
				"the-channel-account-status-is-invalid"));
	}
