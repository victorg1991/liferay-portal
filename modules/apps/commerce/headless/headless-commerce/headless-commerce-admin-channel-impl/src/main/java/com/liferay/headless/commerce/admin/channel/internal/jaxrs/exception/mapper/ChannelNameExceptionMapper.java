...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Channel.ChannelNameExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class ChannelNameExceptionMapper
	extends BaseExceptionMapper<CommerceChannelNameException> {

	@Override
	protected Problem getProblem(
		CommerceChannelNameException commerceChannelNameException) {
