...
public abstract class BaseAttachmentResourceTestCase {
	...
	public void testGetCartAttachmentsPage() throws Exception {
		...
		Page<Attachment> page = attachmentResource.getCartAttachmentsPage(
			cartId, null, null, Pagination.of(1, 10), null);
	...
	@Test
	public void testGetCartAttachmentsPageWithFilterDateTimeEquals()
		throws Exception {
	...
	@Test
	public void testGetCartAttachmentsPageWithFilterDoubleEquals()
		throws Exception {

		testGetCartAttachmentsPageWithFilter("eq", EntityField.Type.DOUBLE);
	}

	@Test
	public void testGetCartAttachmentsPageWithFilterStringContains()
		throws Exception {

		testGetCartAttachmentsPageWithFilter(
			"contains", EntityField.Type.STRING);
	}

	@Test
	public void testGetCartAttachmentsPageWithFilterStringEquals()
		throws Exception {

		testGetCartAttachmentsPageWithFilter("eq", EntityField.Type.STRING);
	}

	@Test
	public void testGetCartAttachmentsPageWithFilterStringStartsWith()
		throws Exception {
	...
	protected void testGetCartAttachmentsPageWithFilter(
	...
	public void testGetCartAttachmentsPageWithPagination() throws Exception {
		...
		if (totalCount >= (pageSizeLimit - 2)) {
			...
			Page<Attachment> page1 = attachmentResource.getCartAttachmentsPage(
				cartId, null, null, Pagination.of(1, totalCount + 2), null);
			...
			Page<Attachment> page2 = attachmentResource.getCartAttachmentsPage(
				cartId, null, null, Pagination.of(2, totalCount + 2), null);
	...
	@Test
	public void testGetCartAttachmentsPageWithSortDateTime() throws Exception {
		testGetCartAttachmentsPageWithSort(
			EntityField.Type.DATE_TIME,
	...
	@Test
	public void testGetCartAttachmentsPageWithSortDouble() throws Exception {
		testGetCartAttachmentsPageWithSort(
	...
	@Test
	public void testGetCartAttachmentsPageWithSortInteger() throws Exception {
		testGetCartAttachmentsPageWithSort(
	...
	@Test
	public void testGetCartAttachmentsPageWithSortString() throws Exception {
		testGetCartAttachmentsPageWithSort(
	...
	protected void testGetCartAttachmentsPageWithSort(
	...
	@Test
	public void testGetCartByExternalReferenceCodeAttachmentsPageWithFilterDateTimeEquals()
		throws Exception {
	...
	@Test
	public void testGetCartByExternalReferenceCodeAttachmentsPageWithFilterDoubleEquals()
		throws Exception {

		testGetCartByExternalReferenceCodeAttachmentsPageWithFilter(
			"eq", EntityField.Type.DOUBLE);
	}

	@Test
	public void testGetCartByExternalReferenceCodeAttachmentsPageWithFilterStringContains()
		throws Exception {
	...
	@Test
	public void testGetCartByExternalReferenceCodeAttachmentsPageWithFilterStringEquals()
		throws Exception {
	...
	@Test
	public void testGetCartByExternalReferenceCodeAttachmentsPageWithFilterStringStartsWith()
		throws Exception {
	...
	protected void testGetCartByExternalReferenceCodeAttachmentsPageWithFilter(
			String operator, EntityField.Type type)
		throws Exception {
	...
	@Test
	public void testGetCartByExternalReferenceCodeAttachmentsPageWithSortDateTime()
		throws Exception {

		testGetCartByExternalReferenceCodeAttachmentsPageWithSort(
			EntityField.Type.DATE_TIME,
			(entityField, attachment1, attachment2) -> {
				BeanTestUtil.setProperty(
					attachment1, entityField.getName(),
	...
	@Test
	public void testGetCartByExternalReferenceCodeAttachmentsPageWithSortDouble()
		throws Exception {
	...
	@Test
	public void testGetCartByExternalReferenceCodeAttachmentsPageWithSortInteger()
		throws Exception {
	...
	@Test
	public void testGetCartByExternalReferenceCodeAttachmentsPageWithSortString()
		throws Exception {
	...
	protected void testGetCartByExternalReferenceCodeAttachmentsPageWithSort(
			EntityField.Type type,
			UnsafeTriConsumer<EntityField, Attachment, Attachment, Exception>
				unsafeTriConsumer)
		throws Exception {
