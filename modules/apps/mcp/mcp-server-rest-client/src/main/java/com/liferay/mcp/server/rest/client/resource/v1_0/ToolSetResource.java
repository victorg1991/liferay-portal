...
public interface ToolSetResource {
	...
	public static class Builder {
		...
		public ToolSetResource build() {
			return new ToolSetResourceImpl(this);
		}
	...
	public static class ToolSetResourceImpl implements ToolSetResource {
		...
		public Page<ToolSet> getToolSetsPage() throws Exception {
			...
			try {
				return Page.of(content, ToolSetSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private ToolSetResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ToolSetResource.class.getName());
