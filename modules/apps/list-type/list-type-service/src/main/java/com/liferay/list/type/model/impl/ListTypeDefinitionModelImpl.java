...
/**
 * The base model implementation for the ListTypeDefinition service. Represents a row in the &quot;ListTypeDefinition&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface <code>ListTypeDefinitionModel</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ListTypeDefinitionImpl}.
 * </p>
 *
...
public class ListTypeDefinitionModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "ListTypeDefinition";
	...
	public void setPrimaryKey(long primaryKey) {
		setListTypeDefinitionId(primaryKey);
	}
	...
	public Map<String, Object> getModelAttributes() {
		...
		for (Map.Entry<String, Function<ListTypeDefinition, Object>> entry :
			...
			attributes.put(
				attributeName,
				attributeGetterFunction.apply((ListTypeDefinition)this));
		}
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<ListTypeDefinition, Object>>
			attributeSetterBiConsumers = getAttributeSetterBiConsumers();

		for (Map.Entry<String, Object> entry : attributes.entrySet()) {
			String attributeName = entry.getKey();

			BiConsumer<ListTypeDefinition, Object> attributeSetterBiConsumer =
				attributeSetterBiConsumers.get(attributeName);

			if (attributeSetterBiConsumer != null) {
				attributeSetterBiConsumer.accept(
					(ListTypeDefinition)this, entry.getValue());
			}
		}
	}
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put(
				"status", ListTypeDefinition::getStatus);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"status",
				(BiConsumer<ListTypeDefinition, Integer>)
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(
			getCompanyId(), ListTypeDefinition.class.getName(),
			getPrimaryKey());
	}
	...
	public void prepareLocalizedFieldsForImport() throws LocaleException {
		...
		Locale defaultImportLocale = LocalizationUtil.getDefaultImportLocale(
			ListTypeDefinition.class.getName(), getPrimaryKey(), defaultLocale,
			availableLocales);
	...
	@Override
	public ListTypeDefinition toEscapedModel() {
		if (_escapedModel == null) {
			Function<InvocationHandler, ListTypeDefinition>
	...
	public Object clone() {
		...
		listTypeDefinitionImpl.setUserId(getUserId());
		...
		listTypeDefinitionImpl.setStatus(getStatus());
	...
	public ListTypeDefinition cloneWithOriginalValues() {
		...
		listTypeDefinitionImpl.setStatus(
	...
	@Override
	public CacheModel<ListTypeDefinition> toCacheModel() {
		ListTypeDefinitionCacheModel listTypeDefinitionCacheModel =
			new ListTypeDefinitionCacheModel();

		listTypeDefinitionCacheModel.mvccVersion = getMvccVersion();

		listTypeDefinitionCacheModel.uuid = getUuid();

		String uuid = listTypeDefinitionCacheModel.uuid;
		...
		listTypeDefinitionCacheModel.companyId = getCompanyId();

		listTypeDefinitionCacheModel.userId = getUserId();

		listTypeDefinitionCacheModel.userName = getUserName();

		String userName = listTypeDefinitionCacheModel.userName;

		if ((userName != null) && (userName.length() == 0)) {
			listTypeDefinitionCacheModel.userName = null;
		}

		Date createDate = getCreateDate();

		if (createDate != null) {
			listTypeDefinitionCacheModel.createDate = createDate.getTime();
		}
		else {
			listTypeDefinitionCacheModel.createDate = Long.MIN_VALUE;
		}

		Date modifiedDate = getModifiedDate();

		if (modifiedDate != null) {
			listTypeDefinitionCacheModel.modifiedDate = modifiedDate.getTime();
		}
		else {
		...
		listTypeDefinitionCacheModel.status = getStatus();
	...
	public <T> T getColumnValue(String columnName) {
		...
		return (T)function.apply((ListTypeDefinition)this);
	}
