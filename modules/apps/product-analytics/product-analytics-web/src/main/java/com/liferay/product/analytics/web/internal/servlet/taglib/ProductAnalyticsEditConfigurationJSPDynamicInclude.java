...
public class ProductAnalyticsEditConfigurationJSPDynamicInclude
	...
	public void include(
		...
		try {
			httpServletRequest.setAttribute(
				ProductAnalyticsConfiguration.class.getName(),
	...
	public void register(DynamicIncludeRegistry dynamicIncludeRegistry) {
		dynamicIncludeRegistry.register(
			StringBundler.concat(
				...
				"com.liferay.product.analytics.web.internal.configuration.",
				"ProductAnalyticsConfiguration#pre"));
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProductAnalyticsEditConfigurationJSPDynamicInclude.class);
