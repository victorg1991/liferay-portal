...
/**
 * Provides the local service interface for ObjectViewFilterColumn. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marco Leo
 * @see ObjectViewFilterColumnLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ObjectViewFilterColumnLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.object.service.impl.ObjectViewFilterColumnLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the object view filter column local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ObjectViewFilterColumnLocalServiceUtil} if injection and service tracking are not available.
	 */
