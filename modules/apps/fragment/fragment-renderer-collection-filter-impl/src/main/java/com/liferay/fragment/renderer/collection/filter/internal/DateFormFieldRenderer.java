...
@Component(
	...
	property =
		"info.field.type=com.liferay.info.field.type.DateInfoFieldType")

public class DateFormFieldRenderer implements FormFieldRenderer {
	@Override
	public void render(
		...
		try {
			RequestDispatcher requestDispatcher =
				_servletContext.getRequestDispatcher("/form_field_date.jsp");
