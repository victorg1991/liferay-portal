...
/**
 * Provides the base implementation for the launch set local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.launch.service.impl.LaunchSetLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.launch.service.impl.LaunchSetLocalServiceImpl
 * @generated
 */
public abstract class LaunchSetLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, LaunchSetLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LaunchSetLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.launch.service.LaunchSetLocalServiceUtil</code>.
	 */
	...
	public LaunchSet createLaunchSet(long launchSetId) {
		return launchSetPersistence.create(launchSetId);
	}
	...
	public LaunchSet deleteLaunchSet(LaunchSet launchSet) {
		return launchSetPersistence.remove(launchSet);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return launchSetPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LaunchSet.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return launchSetPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return launchSetPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return launchSetPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return launchSetPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LaunchSet fetchLaunchSet(long launchSetId) {
		return launchSetPersistence.fetchByPrimaryKey(launchSetId);
	}
	...
	public LaunchSet fetchLaunchSetByUuidAndCompanyId(
		...
		return launchSetPersistence.fetchByUuid_C_First(uuid, companyId, null);
	}
	...
	public LaunchSet fetchLaunchSetByExternalReferenceCode(
		...
		return launchSetPersistence.fetchByERC_C(
	...
	public LaunchSet getLaunchSetByExternalReferenceCode(
		...
		return launchSetPersistence.findByERC_C(
			externalReferenceCode, companyId);
	}
	...
	public LaunchSet getLaunchSet(long launchSetId) throws PortalException {
		return launchSetPersistence.findByPrimaryKey(launchSetId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(launchSetLocalService);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return launchSetPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement LaunchSetLocalServiceImpl#deleteLaunchSet(LaunchSet) to avoid orphaned data");
		}

		return launchSetLocalService.deleteLaunchSet((LaunchSet)persistedModel);
	}

	@Override
	public BasePersistence<LaunchSet> getBasePersistence() {
		return launchSetPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return launchSetPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public LaunchSet getLaunchSetByUuidAndCompanyId(String uuid, long companyId)
		...
		return launchSetPersistence.findByUuid_C_First(uuid, companyId, null);
	}
	...
	public List<LaunchSet> getLaunchSets(int start, int end) {
		return launchSetPersistence.findAll(start, end);
	}
	...
	public int getLaunchSetsCount() {
		return launchSetPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LaunchSetLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		launchSetLocalService = (LaunchSetLocalService)aopProxy;
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = launchSetPersistence.getDataSource();
