...
@Component(
	property = {
		...
		"mvc.command.name=/layout_admin/create_layout_page_template_entry"
	},
	service = MVCActionCommand.class
)
public class CreateLayoutPageTemplateEntryMVCActionCommand
	extends BaseLayoutAdminTransactionalMVCActionCommand {
	...
	protected JSONObject doTransactionalCommand(
		...
		long layoutId = ParamUtil.getLong(actionRequest, "itemId");

		long segmentsExperienceId =
			_segmentsExperienceLocalService.fetchDefaultSegmentsExperienceId(
				layoutId);

		Layout sourceLayout = _layoutLocalService.getLayout(layoutId);
