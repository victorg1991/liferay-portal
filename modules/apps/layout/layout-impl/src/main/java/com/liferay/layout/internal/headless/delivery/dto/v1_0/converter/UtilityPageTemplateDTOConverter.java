...
public class UtilityPageTemplateDTOConverter {
	...
	public static UtilityPageTemplate toDTO(
		...
		return new UtilityPageTemplate() {
			{
				defaultTemplate = layoutUtilityPageEntry.isDefaultLayoutUtilityPageEntry();
				externalReferenceCode = layoutUtilityPageEntry.getExternalReferenceCode();
				name = layoutUtilityPageEntry.getName();
				type = Type.create(UtilityPageTemplateTypeConverter.convertToExternalValue(layoutUtilityPageEntry.getType()));
			}
		};
	}
