...
import com.liferay.layout.exception.UtilityPageTemplateValidatorException;
import com.liferay.layout.importer.LayoutsImporter;
import com.liferay.layout.importer.LayoutsImporterResultEntry;
import com.liferay.layout.internal.exception.DropzoneLayoutStructureItemException;
import com.liferay.layout.internal.headless.delivery.dto.v1_0.converter.UtilityPageTemplateTypeConverter;
...
import com.liferay.layout.validator.UtilityPageTemplateValidator;
...
public class LayoutsImporterImpl implements LayoutsImporter {
	...
	private boolean _isUtilityPageTemplateFile(String fileName) {
		if (fileName.endsWith(
				CharPool.SLASH +
					LayoutPageTemplateExportImportConstants.
						FILE_NAME_UTILITY_PAGE_TEMPLATE)) {
		...
		try {
			...
			if (added) {
				...
				_processPageDefinition(
					layoutPageTemplateEntry.getPlid(), pageDefinition, warningMessages);
	...
	private LayoutUtilityPageEntry _processLayoutUtilityPageTemplateEntry(
		String externalReferenceCode, long groupId,
		LayoutUtilityPageEntry layoutUtilityPageEntry, String name,
		PageDefinition pageDefinition, int layoutUtilityPageEntryType, boolean overwrite, ZipEntry thumbnailZipEntry, String zipPath,
		ZipFile zipFile)
		throws Exception {
		...
		try {
			...
			if (layoutUtilityPageEntry == null) {
				layoutUtilityPageEntry =
					_layoutUtilityPageEntryService.
						addLayoutUtilityPageEntry(externalReferenceCode,
							groupId, name,
			...
			if (added) {
				...
				_processPageDefinition(
					layoutUtilityPageEntry.getPlid(), pageDefinition, warningMessages);
				...
				_layoutPageTemplatesImporterResultEntries.add(
					new LayoutsImporterResultEntry(
						...
						_getErrorMessage(
							...
							new String[] {
								zipPath,
								_toTypeName(layoutUtilityPageEntryType)
							})));
			}
		}
		catch (DropzoneLayoutStructureItemException
	...
	private void _processPageDefinition(
		...
		_updateLayouts(layoutPageTemplateEntry.getPlid());
	}
	...
	private void _updateLayouts(long plid)
		throws Exception {
	...
	private class UtilityPageImporterCallable implements Callable<Void> {
		...
		@Override
		public Void call() throws Exception {
			UtilityPageTemplate utilityPageTemplate = _utilityPageTemplateEntry.getUtilityPageTemplate();

			LayoutUtilityPageEntry layoutUtilityPageEntry =
				_layoutUtilityPageEntryLocalService.
					fetchLayoutUtilityPageEntry(_groupId, utilityPageTemplate.getExternalReferenceCode());

			_processLayoutUtilityPageTemplateEntry(
				utilityPageTemplate.getExternalReferenceCode(), _groupId, layoutUtilityPageEntry,
				utilityPageTemplate.getName(), _utilityPageTemplateEntry.getPageDefinition(),
				UtilityPageTemplateTypeConverter.convertToInternalValue(String.valueOf(utilityPageTemplate.getType())),
