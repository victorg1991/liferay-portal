...
@Component(
	property = {
		...
		"jakarta.portlet.name=" + LayoutPageTemplateAdminWebPortletKeys.LAYOUT_PAGE_TEMPLATE_ADMIN_WEB_TEST_PORTLET,
		"jakarta.portlet.version=4.0"
	},
	service = Portlet.class
)
public class LayoutPageTemplateAdminWebTestPortlet extends MVCPortlet {
}