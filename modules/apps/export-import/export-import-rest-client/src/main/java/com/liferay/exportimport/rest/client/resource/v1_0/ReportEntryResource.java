...
public interface ReportEntryResource {
	...
	public static class Builder {
		...
		public ReportEntryResource build() {
			return new ReportEntryResourceImpl(this);
		}
	...
	public static class ReportEntryResourceImpl implements ReportEntryResource {
		...
		public Page<ReportEntry> getImportProcessReportEntriesPage(
			...
			try {
				return Page.of(content, ReportEntrySerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public ReportEntry getReportEntry(Long reportEntryId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getReportEntryHttpResponse(
				reportEntryId);
			...
			try {
				return ReportEntrySerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private ReportEntryResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ReportEntryResource.class.getName());
