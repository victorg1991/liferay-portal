...
public class PerformanceMetric implements Serializable {
	...
	public static PerformanceMetric toDTO(String json) {
		return ObjectMapperUtil.readValue(PerformanceMetric.class, json);
	}

	public static PerformanceMetric unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(PerformanceMetric.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.analytics.cms.rest.dto.v1_0.PerformanceMetric",
		name = "x-class-name"
	)
