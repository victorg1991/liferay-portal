...
public abstract class BaseOverviewResourceTestCase {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("categoriesCount")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}

		if (entityFieldName.equals("tagsCount")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
		...
		if (entityFieldName.equals("vocabulariesCount")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
		...
		return new Overview() {
			{
				...
				vocabulariesCount = RandomTestUtil.randomLong();
			}
		};
	}
