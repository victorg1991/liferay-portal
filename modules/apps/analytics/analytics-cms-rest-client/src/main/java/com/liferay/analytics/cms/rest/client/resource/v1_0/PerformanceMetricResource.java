...
public interface PerformanceMetricResource {
	...
	public static class Builder {
		...
		public PerformanceMetricResource build() {
			return new PerformanceMetricResourceImpl(this);
		}
	...
	public static class PerformanceMetricResourceImpl
		...
		public PerformanceMetric getPerformanceMetric(
			...
			try {
				return PerformanceMetricSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private static final Logger _logger = Logger.getLogger(
			PerformanceMetricResource.class.getName());
