 ...
 */
@Component(
	property = "frontend.data.set.name=" + CMSSiteInitializerFDSNames.BULK_ACTION_TASK_REPORT_ERROR_ITEMS_SECTION,
	service = FDSView.class
)
public class BulkActionTaskReportErrorItemsTableFDSView
