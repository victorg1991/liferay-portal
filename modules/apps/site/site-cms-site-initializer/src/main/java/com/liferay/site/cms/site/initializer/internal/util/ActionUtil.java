...
public class ActionUtil {
	...
	private static LayoutStructure _addAccordionFragmentEntryLink(
			...
			JSONObject titleJSONObject, ServiceContext serviceContext)
		throws Exception {
	...
	private static LayoutStructure _addInputFragmentEntryLinks(
		...
		if (infoFieldSet.isRelationship()) {
			...
			layoutStructure = _addAccordionFragmentEntryLink(
				accordionItemId, fragmentEntryLinkListenerRegistry,
				fragmentEntryLinkService, fragmentRendererRegistry, layout,
				layoutStructure, layoutStructureItem.getItemId(),
				segmentsExperienceId, stylesJSONObject,
	...
	private static LayoutStructure _addObjectLayoutFragmentEntryLinks(
		...
		for (int i = 0; i < objectLayoutTabs.size(); i++) {
			...
			layoutStructure = _addAccordionFragmentEntryLink(
				tabAccordionItemId, fragmentEntryLinkListenerRegistry,
				fragmentEntryLinkService, fragmentRendererRegistry, layout,
			...
			for (ObjectLayoutBox objectLayoutBox :
				...
				if (objectLayoutBox.isCollapsable()) {
					...
					layoutStructure = _addAccordionFragmentEntryLink(
						boxAccordionItemId, fragmentEntryLinkListenerRegistry,
						fragmentEntryLinkService, fragmentRendererRegistry,
						layout, layoutStructure, tabContentItemId,
