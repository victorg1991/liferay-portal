...
public interface FriendlyURLEntryPersistence
	extends BasePersistence<FriendlyURLEntry>, CTPersistence<FriendlyURLEntry> {
	 ...
	 * @return the matching friendly url entries
	 */
	public java.util.List<FriendlyURLEntry> findByG_C(
	 ...
	 * @return the matching friendly url entries
	 */
	public java.util.List<FriendlyURLEntry> findByC_C(
...
// LIFERAY-SERVICE-BUILDER-HASH:1981123741