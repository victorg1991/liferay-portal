...
boolean enableSuccessPage = GetterUtil.getBoolean(String.valueOf(request.getAttribute("liferay-data-engine:data-layout-builder:enableSuccessPage")), true);
...
boolean singlePage = GetterUtil.getBoolean(String.valueOf(request.getAttribute("liferay-data-engine:data-layout-builder:singlePage")));
