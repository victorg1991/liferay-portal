...
/**
 * The persistence utility for the wiki page resource service. This utility wraps <code>com.liferay.wiki.service.persistence.impl.WikiPageResourcePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class WikiPageResourceUtil {
	 ...
	 */
	public static Map<Serializable, WikiPageResource> fetchByPrimaryKeys(
	 ...
	 */
	public static WikiPageResource update(
		WikiPageResource wikiPageResource, ServiceContext serviceContext) {
	 ...
	 */
	public static WikiPageResource findByUuid_First(
	 ...
	 */
	public static WikiPageResource fetchByUuid_First(
		String uuid, OrderByComparator<WikiPageResource> orderByComparator) {
	 ...
	 * @throws NoSuchPageResourceException if a matching wiki page resource could not be found
	 */
	public static WikiPageResource findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<WikiPageResource> orderByComparator)
		throws com.liferay.wiki.exception.NoSuchPageResourceException {
	 ...
	 * @return the first matching wiki page resource, or <code>null</code> if a matching wiki page resource could not be found
	 */
	public static WikiPageResource fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<WikiPageResource> orderByComparator) {
	...
	public static WikiPageResource updateImpl(
