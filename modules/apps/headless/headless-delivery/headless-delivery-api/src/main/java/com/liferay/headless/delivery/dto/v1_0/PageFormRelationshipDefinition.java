...
@Generated("")
@GraphQLName(
	description = "Represents a definition of a Form Relationship.",
	value = "PageFormRelationshipDefinition"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "Represents a definition of a Form Relationship."
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "PageFormRelationshipDefinition")
public class PageFormRelationshipDefinition implements Serializable {

	public static PageFormRelationshipDefinition toDTO(String json) {
		return ObjectMapperUtil.readValue(
			PageFormRelationshipDefinition.class, json);
	}

	public static PageFormRelationshipDefinition unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			PageFormRelationshipDefinition.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized button label."
	)
	@Valid
	public FragmentInlineValue getButtonLabel() {
		if (_buttonLabelSupplier != null) {
			buttonLabel = _buttonLabelSupplier.get();

			_buttonLabelSupplier = null;
		}

		return buttonLabel;
	}

	public void setButtonLabel(FragmentInlineValue buttonLabel) {
	...
	public void setButtonLabel(
		UnsafeSupplier<FragmentInlineValue, Exception>
			buttonLabelUnsafeSupplier) {

		_buttonLabelSupplier = () -> {
			try {
				return buttonLabelUnsafeSupplier.get();
			}
	...
	@GraphQLField(description = "The localized button label.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected FragmentInlineValue buttonLabel;

	@JsonIgnore
	private Supplier<FragmentInlineValue> _buttonLabelSupplier;
	...
	@GraphQLField(description = "The content type.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof PageFormRelationshipDefinition)) {
			return false;
		}

		PageFormRelationshipDefinition pageFormRelationshipDefinition =
			(PageFormRelationshipDefinition)object;

		return Objects.equals(
			toString(), pageFormRelationshipDefinition.toString());
	}
	...
	public String toString() {
		...
		FragmentInlineValue buttonLabel = getButtonLabel();
		...
		if (buttonLabel != null) {
			...
			sb.append(String.valueOf(buttonLabel));
		}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.delivery.dto.v1_0.PageFormRelationshipDefinition",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1789993575