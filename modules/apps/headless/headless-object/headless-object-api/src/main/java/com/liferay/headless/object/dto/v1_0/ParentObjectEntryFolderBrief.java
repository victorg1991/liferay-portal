...
public class ParentObjectEntryFolderBrief implements Serializable {
	...
	public static ParentObjectEntryFolderBrief toDTO(String json) {
		return ObjectMapperUtil.readValue(
			ParentObjectEntryFolderBrief.class, json);
	}

	public static ParentObjectEntryFolderBrief unsafeToDTO(String json) {
	...
	@GraphQLField(description = "The parent object entry folder's ID.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected Long id;
	...
	@GraphQLField(description = "The parent object entry folder's label.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.object.dto.v1_0.ParentObjectEntryFolderBrief",
		name = "x-class-name"
	)
