...
public interface StyleBookResource {
	...
	public HttpInvoker.HttpResponse deleteSiteStyleBookHttpResponse(
			String siteExternalReferenceCode,
			String styleBookExternalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse patchSiteStyleBookHttpResponse(
			String siteExternalReferenceCode,
			String styleBookExternalReferenceCode, StyleBook styleBook)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postSiteStyleBookHttpResponse(
			String siteExternalReferenceCode, StyleBook styleBook)
		throws Exception;

	public void postSiteStyleBookBatch(
			String siteExternalReferenceCode, String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postSiteStyleBookBatchHttpResponse(
			String siteExternalReferenceCode, String callbackURL, Object object)
		throws Exception;

	public void postSiteStyleBooksPageExportBatch(
			String siteExternalReferenceCode, String search,
	...
	public HttpInvoker.HttpResponse
			postSiteStyleBooksPageExportBatchHttpResponse(
				String siteExternalReferenceCode, String search,
				String filterString, String sortString, String callbackURL,
				String contentType, String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse putSiteStyleBookHttpResponse(
			String siteExternalReferenceCode,
			String styleBookExternalReferenceCode, StyleBook styleBook)
		throws Exception;
	...
	public static class Builder {
		...
		public StyleBookResource build() {
			return new StyleBookResourceImpl(this);
		}
	...
	public static class StyleBookResourceImpl implements StyleBookResource {
		...
		public void deleteSiteStyleBook(
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteSiteStyleBookHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/style-books/{styleBookExternalReferenceCode}");
		...
		public Page<StyleBook> getSiteStyleBooksPage(
			...
			try {
				return Page.of(content, StyleBookSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getSiteStyleBooksPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/style-books");
		...
		public StyleBook patchSiteStyleBook(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchSiteStyleBookHttpResponse(
					siteExternalReferenceCode, styleBookExternalReferenceCode,
					styleBook);
		...
		public HttpInvoker.HttpResponse patchSiteStyleBookHttpResponse(
			...
			httpInvoker.body(styleBook.toString(), "application/json");
		...
		public void postSiteStyleBookBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postSiteStyleBookBatchHttpResponse(
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/style-books/export-batch");
		...
		private StyleBookResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			StyleBookResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:1805492323