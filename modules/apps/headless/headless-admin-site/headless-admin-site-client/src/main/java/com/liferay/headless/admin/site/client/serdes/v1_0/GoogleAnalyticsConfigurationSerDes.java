...
public class GoogleAnalyticsConfigurationSerDes {
	...
	public static String toJSON(
		...
		if (googleAnalyticsConfiguration.getGoogleAnalytics4CustomConfig() !=
				null) {
		...
		if (googleAnalyticsConfiguration.
				getGoogleAnalyticsCreateCustomConfig() != null) {
		...
		if (googleAnalyticsConfiguration.getGoogleAnalyticsCustomConfig() !=
				null) {
	...
	public static Map<String, String> toMap(
		...
		if (googleAnalyticsConfiguration.getGoogleAnalytics4CustomConfig() ==
			...
			map.put("googleAnalytics4CustomConfig", null);
		}
		else {
			map.put(
		...
		if (googleAnalyticsConfiguration.
			...
			map.put("googleAnalyticsCreateCustomConfig", null);
		}
		else {
			map.put(
		...
		if (googleAnalyticsConfiguration.getGoogleAnalyticsCustomConfig() ==
			...
			map.put("googleAnalyticsCustomConfig", null);
		}
		else {
			map.put(
	...
	public static class GoogleAnalyticsConfigurationJSONParser
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			if (Objects.equals(
					jsonParserFieldName, "googleAnalytics4CustomConfig")) {
				...
				return false;
						...
						jsonParserFieldName, "googleAnalyticsCustomConfig")) {
		...
		protected void setField(
			...
			if (Objects.equals(
				...
				if (jsonParserFieldValue != null) {
					googleAnalyticsConfiguration.setGoogleAnalyticsCustomConfig(
						(String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "googleAnalyticsId")) {
