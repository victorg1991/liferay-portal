...
public class SelectFragmentConfigurationFieldValueSerDes {
	...
	public static String toJSON(
		...
		if (selectFragmentConfigurationFieldValue.getValue() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(
				_escape(selectFragmentConfigurationFieldValue.getValue()));

			sb.append("\"");
		}

		if (selectFragmentConfigurationFieldValue.getValue_i18n() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(
				_toJSON(selectFragmentConfigurationFieldValue.getValue_i18n()));
		}

		if (selectFragmentConfigurationFieldValue.getType() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
	...
	public static Map<String, String> toMap(
		...
		if (selectFragmentConfigurationFieldValue.getType() == null) {
			...
			map.put(
				"type",
				String.valueOf(
					selectFragmentConfigurationFieldValue.getType()));
		}
	...
	public static class SelectFragmentConfigurationFieldValueJSONParser
		...
		protected SelectFragmentConfigurationFieldValue createDTO() {
			return new SelectFragmentConfigurationFieldValue();
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "value")) {
				...
				if (jsonParserFieldValue != null) {
					selectFragmentConfigurationFieldValue.setType(
						SelectFragmentConfigurationFieldValue.Type.create(
							(String)jsonParserFieldValue));
				}
			}
		}
