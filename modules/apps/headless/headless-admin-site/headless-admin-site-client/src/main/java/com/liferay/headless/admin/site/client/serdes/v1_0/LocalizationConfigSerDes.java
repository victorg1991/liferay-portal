...
public class LocalizationConfigSerDes {
	...
	public static String toJSON(LocalizationConfig localizationConfig) {
		...
		if (localizationConfig.
				getUnlocalizedFieldsMessageFragmentInlineValue() != null) {

			if (sb.length() > 1) {
				sb.append(", ");
			}

			sb.append("\"unlocalizedFieldsMessageFragmentInlineValue\": ");
	...
	public static Map<String, String> toMap(
		...
		if (localizationConfig.
			...
			map.put("unlocalizedFieldsMessageFragmentInlineValue", null);
		}
		else {
			map.put(
...
// LIFERAY-REST-BUILDER-HASH:-1903604857