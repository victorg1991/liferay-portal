...
public class FormRelationshipPageElementDefinition
	...
	public static FormRelationshipPageElementDefinition toDTO(String json) {
		return ObjectMapperUtil.readValue(
			FormRelationshipPageElementDefinition.class, json);
	}

	public static FormRelationshipPageElementDefinition unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "A list of CSS classes that are applied to the form relationship page element."
	)
	...
	public FormRelationshipConfig getFormRelationshipConfig() {
		if (_formRelationshipConfigSupplier != null) {
			formRelationshipConfig = _formRelationshipConfigSupplier.get();

			_formRelationshipConfigSupplier = null;
		}
	...
	public void setFormRelationshipConfig(
		...
		_formRelationshipConfigSupplier = () -> {
			try {
				return formRelationshipConfigUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<FormRelationshipConfig> _formRelationshipConfigSupplier;

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "A list of fragment viewports of a form relationship page element."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "A flag that indicates whether the form relationship is indexed or not."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The custom name of a form relationship page element."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Whether the form relationship can be repeated."
	)
	...
	public String toString() {
		...
		if (formRelationshipConfig != null) {
			...
			sb.append(String.valueOf(formRelationshipConfig));
		}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.FormRelationshipPageElementDefinition",
		name = "x-class-name"
	)
