...
@XmlRootElement(name = "PageTemplateSettings")
public abstract class PageTemplateSettings implements Serializable {

	public static PageTemplateSettings toDTO(String json) {
		return ObjectMapperUtil.readValue(PageTemplateSettings.class, json);
	}

	public static PageTemplateSettings unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.PageTemplateSettings",
		name = "x-class-name"
	)
