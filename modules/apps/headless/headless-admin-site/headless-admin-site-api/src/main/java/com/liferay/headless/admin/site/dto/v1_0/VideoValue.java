...
public class VideoValue implements Serializable {
	...
	public static VideoValue toDTO(String json) {
		return ObjectMapperUtil.readValue(VideoValue.class, json);
	}

	public static VideoValue unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(VideoValue.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.VideoValue",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1778796500