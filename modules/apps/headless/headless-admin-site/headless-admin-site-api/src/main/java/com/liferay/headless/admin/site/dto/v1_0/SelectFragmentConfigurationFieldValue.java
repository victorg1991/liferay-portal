...
@Generated("")
@GraphQLName(
	description = "The value of a fragment configuration field of type select.",
	value = "SelectFragmentConfigurationFieldValue"
)
...
public class SelectFragmentConfigurationFieldValue
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the fragment configuration field of type select."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the fragment configuration field of type select."
	)
	@Valid
...
// LIFERAY-REST-BUILDER-HASH:-1737651490