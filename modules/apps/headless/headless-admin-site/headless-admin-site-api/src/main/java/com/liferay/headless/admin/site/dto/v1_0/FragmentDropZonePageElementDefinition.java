...
public class FragmentDropZonePageElementDefinition
	...
	public static FragmentDropZonePageElementDefinition toDTO(String json) {
		return ObjectMapperUtil.readValue(
			FragmentDropZonePageElementDefinition.class, json);
	}

	public static FragmentDropZonePageElementDefinition unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The id of the fragment drop zone"
	)
	...
	@GraphQLField(description = "The id of the fragment drop zone")
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.FragmentDropZonePageElementDefinition",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-219149919