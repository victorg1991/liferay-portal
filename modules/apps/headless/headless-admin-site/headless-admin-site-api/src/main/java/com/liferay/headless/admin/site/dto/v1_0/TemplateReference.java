...
@Generated("")
@GraphQLName(
	description = "The template's reference.", value = "TemplateReference"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "The template's reference."
)
...
public class TemplateReference implements Serializable {
	...
	public static TemplateReference toDTO(String json) {
		return ObjectMapperUtil.readValue(TemplateReference.class, json);
	}

	public static TemplateReference unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(TemplateReference.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The renderer's key."
	)
	public String getRendererKey() {
		if (_rendererKeySupplier != null) {
			rendererKey = _rendererKeySupplier.get();

			_rendererKeySupplier = null;
		}
	...
	public void setRendererKey(
		...
		_rendererKeySupplier = () -> {
			try {
				return rendererKeyUnsafeSupplier.get();
			}
	...
	@GraphQLField(description = "The renderer's key.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String rendererKey;

	@JsonIgnore
	private Supplier<String> _rendererKeySupplier;

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The template's key."
	)
	...
	@GraphQLField(description = "The template's key.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.TemplateReference",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1169349525