...
public class TargetCollectionDisplayFragmentConfigurationFieldValue
	...
	public static TargetCollectionDisplayFragmentConfigurationFieldValue toDTO(
		...
		return ObjectMapperUtil.readValue(
			TargetCollectionDisplayFragmentConfigurationFieldValue.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The page element external reference codes of the target collection displays."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized page element external reference codes of the target collection displays."
	)
	@Valid
	...
	@JsonIgnore
	private Supplier<Object> _value_i18nSupplier;
	...
	public String toString() {
		...
		Object value_i18n = getValue_i18n();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.TargetCollectionDisplayFragmentConfigurationFieldValue",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1028361154