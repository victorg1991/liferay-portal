...
public class NestedApplicationsWidgetPageWidgetInstance
	...
	public static NestedApplicationsWidgetPageWidgetInstance toDTO(
		...
		return ObjectMapperUtil.readValue(
			NestedApplicationsWidgetPageWidgetInstance.class, json);
	}

	public static NestedApplicationsWidgetPageWidgetInstance unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The sections of a nested applications widget instance."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.NestedApplicationsWidgetPageWidgetInstance",
		name = "x-class-name"
	)
