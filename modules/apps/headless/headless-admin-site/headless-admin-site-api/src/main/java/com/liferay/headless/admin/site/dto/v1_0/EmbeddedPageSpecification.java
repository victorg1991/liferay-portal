...
public class EmbeddedPageSpecification
	...
	public static EmbeddedPageSpecification toDTO(String json) {
		return ObjectMapperUtil.readValue(
			EmbeddedPageSpecification.class, json);
	}

	public static EmbeddedPageSpecification unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.EmbeddedPageSpecification",
		name = "x-class-name"
	)
