...
public class LinkToPagePageSpecification
	...
	public static LinkToPagePageSpecification toDTO(String json) {
		return ObjectMapperUtil.readValue(
			LinkToPagePageSpecification.class, json);
	}

	public static LinkToPagePageSpecification unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.LinkToPagePageSpecification",
		name = "x-class-name"
	)
