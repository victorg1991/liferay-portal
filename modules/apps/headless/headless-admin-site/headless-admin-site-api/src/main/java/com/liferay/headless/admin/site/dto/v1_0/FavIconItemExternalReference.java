...
public class FavIconItemExternalReference
	extends FavIcon implements Serializable {

	public static FavIconItemExternalReference toDTO(String json) {
		return ObjectMapperUtil.readValue(
			FavIconItemExternalReference.class, json);
	}

	public static FavIconItemExternalReference unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.FavIconItemExternalReference",
		name = "x-class-name"
	)
