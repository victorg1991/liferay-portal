...
public class CollectionItemPageElementDefinition
	...
	public static CollectionItemPageElementDefinition toDTO(String json) {
		return ObjectMapperUtil.readValue(
			CollectionItemPageElementDefinition.class, json);
	}

	public static CollectionItemPageElementDefinition unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.CollectionItemPageElementDefinition",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1166597316