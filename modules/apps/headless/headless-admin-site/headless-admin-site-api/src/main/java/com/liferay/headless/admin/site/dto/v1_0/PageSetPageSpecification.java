...
@Generated("")
@GraphQLName(
	description = "A page specification of a page set page.",
	value = "PageSetPageSpecification"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "PageSetPageSpecification")
public class PageSetPageSpecification
	...
	public static PageSetPageSpecification toDTO(String json) {
		return ObjectMapperUtil.readValue(PageSetPageSpecification.class, json);
	}

	public static PageSetPageSpecification unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			PageSetPageSpecification.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.PageSetPageSpecification",
		name = "x-class-name"
	)
