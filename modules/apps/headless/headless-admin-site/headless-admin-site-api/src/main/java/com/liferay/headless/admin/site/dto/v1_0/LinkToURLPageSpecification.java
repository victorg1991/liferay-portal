...
@Generated("")
@GraphQLName(
	description = "A page specification of a link to URL page.",
	value = "LinkToURLPageSpecification"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "A page specification of a link to URL page."
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "LinkToURLPageSpecification")
public class LinkToURLPageSpecification
	...
	public static LinkToURLPageSpecification toDTO(String json) {
		return ObjectMapperUtil.readValue(
			LinkToURLPageSpecification.class, json);
	}

	public static LinkToURLPageSpecification unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.LinkToURLPageSpecification",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:614548636