...
public class PageNavigationMenuItemSettings implements Serializable {
	...
	public static PageNavigationMenuItemSettings toDTO(String json) {
		return ObjectMapperUtil.readValue(
			PageNavigationMenuItemSettings.class, json);
	}

	public static PageNavigationMenuItemSettings unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.PageNavigationMenuItemSettings",
		name = "x-class-name"
	)
