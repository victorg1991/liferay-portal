...
public class LengthFragmentConfigurationFieldValue
	...
	public static LengthFragmentConfigurationFieldValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			LengthFragmentConfigurationFieldValue.class, json);
	}

	public static LengthFragmentConfigurationFieldValue unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the fragment configuration field of type length."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the fragment configuration field of type length."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.LengthFragmentConfigurationFieldValue",
		name = "x-class-name"
	)
