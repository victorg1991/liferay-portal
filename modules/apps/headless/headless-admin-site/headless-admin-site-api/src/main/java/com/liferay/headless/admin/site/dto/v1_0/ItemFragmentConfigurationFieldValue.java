...
@Generated("")
@GraphQLName(
	description = "The value of a fragment configuration field of type item.",
	value = "ItemFragmentConfigurationFieldValue"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "The value of a fragment configuration field of type item."
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ItemFragmentConfigurationFieldValue")
public class ItemFragmentConfigurationFieldValue
	...
	public static ItemFragmentConfigurationFieldValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			ItemFragmentConfigurationFieldValue.class, json);
	}

	public static ItemFragmentConfigurationFieldValue unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			ItemFragmentConfigurationFieldValue.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the fragment configuration field of type item."
	)
	@Valid
	...
	@JsonIgnore
	private Supplier<ItemValue> _valueSupplier;

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the fragment configuration field of type item."
	)
	@Valid
	...
	@JsonIgnore
	private Supplier<Map<String, ItemValue>> _value_i18nSupplier;
	...
	public String toString() {
		...
		Map<String, ItemValue> value_i18n = getValue_i18n();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.ItemFragmentConfigurationFieldValue",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1883876148