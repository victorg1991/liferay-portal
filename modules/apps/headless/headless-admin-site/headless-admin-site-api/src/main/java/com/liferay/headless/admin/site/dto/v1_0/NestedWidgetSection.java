...
public class NestedWidgetSection implements Serializable {
	...
	public static NestedWidgetSection toDTO(String json) {
		return ObjectMapperUtil.readValue(NestedWidgetSection.class, json);
	}

	public static NestedWidgetSection unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			NestedWidgetSection.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The nested widget section's id."
	)
	public String getId() {
		if (_idSupplier != null) {
			id = _idSupplier.get();
	...
	@GraphQLField(description = "The nested widget section's id.")
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "A list of the widget instances within this nested widget section."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.NestedWidgetSection",
		name = "x-class-name"
	)
