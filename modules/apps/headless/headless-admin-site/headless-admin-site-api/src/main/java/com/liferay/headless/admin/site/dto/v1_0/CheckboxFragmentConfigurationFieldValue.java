...
public class CheckboxFragmentConfigurationFieldValue
	...
	public static CheckboxFragmentConfigurationFieldValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			CheckboxFragmentConfigurationFieldValue.class, json);
	}

	public static CheckboxFragmentConfigurationFieldValue unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Whether the fragment configuration field of type checkbox is checked."
	)
	...
	@JsonIgnore
	private Supplier<Boolean> _valueSupplier;
	...
	@JsonIgnore
	private Supplier<Map<String, Boolean>> _value_i18nSupplier;
	...
	public String toString() {
		...
		Map<String, Boolean> value_i18n = getValue_i18n();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.CheckboxFragmentConfigurationFieldValue",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-5200763