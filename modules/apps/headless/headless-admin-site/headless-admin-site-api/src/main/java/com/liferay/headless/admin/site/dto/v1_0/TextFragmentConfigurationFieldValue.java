...
public class TextFragmentConfigurationFieldValue
	...
	public static TextFragmentConfigurationFieldValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			TextFragmentConfigurationFieldValue.class, json);
	}

	public static TextFragmentConfigurationFieldValue unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			TextFragmentConfigurationFieldValue.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the fragment configuration field of type text."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the fragment configuration field of type text."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.TextFragmentConfigurationFieldValue",
		name = "x-class-name"
	)
