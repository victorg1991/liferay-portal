...
public class PageSetPageSettings extends PageSettings implements Serializable {
	...
	public static PageSetPageSettings toDTO(String json) {
		return ObjectMapperUtil.readValue(PageSetPageSettings.class, json);
	}

	public static PageSetPageSettings unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			PageSetPageSettings.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.PageSetPageSettings",
		name = "x-class-name"
	)
