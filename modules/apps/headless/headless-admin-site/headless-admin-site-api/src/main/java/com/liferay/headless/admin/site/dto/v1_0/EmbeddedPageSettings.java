...
public class EmbeddedPageSettings extends PageSettings implements Serializable {
	...
	public static EmbeddedPageSettings toDTO(String json) {
		return ObjectMapperUtil.readValue(EmbeddedPageSettings.class, json);
	}

	public static EmbeddedPageSettings unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			EmbeddedPageSettings.class, json);
	}
	...
	@GraphQLField(description = "The URL of the page to embed.")
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.EmbeddedPageSettings",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1251404326