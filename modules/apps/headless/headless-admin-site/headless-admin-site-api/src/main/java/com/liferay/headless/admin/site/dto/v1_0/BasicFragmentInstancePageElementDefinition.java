...
public class BasicFragmentInstancePageElementDefinition
	...
	public static BasicFragmentInstancePageElementDefinition toDTO(
		...
		return ObjectMapperUtil.readValue(
			BasicFragmentInstancePageElementDefinition.class, json);
	}

	public static BasicFragmentInstancePageElementDefinition unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The fragment instance of the basic fragment page element definition."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.BasicFragmentInstancePageElementDefinition",
		name = "x-class-name"
	)
