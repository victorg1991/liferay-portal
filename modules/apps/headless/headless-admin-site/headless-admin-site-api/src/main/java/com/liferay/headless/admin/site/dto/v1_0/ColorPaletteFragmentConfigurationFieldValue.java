...
public class ColorPaletteFragmentConfigurationFieldValue
	...
	public static ColorPaletteFragmentConfigurationFieldValue toDTO(
		...
		return ObjectMapperUtil.readValue(
			ColorPaletteFragmentConfigurationFieldValue.class, json);
	}

	public static ColorPaletteFragmentConfigurationFieldValue unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the fragment configuration field of type color palette."
	)
	@Valid
	...
	@JsonIgnore
	private Supplier<ColorPaletteValue> _valueSupplier;

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the fragment configuration field of type color palette."
	)
	@Valid
	...
	@JsonIgnore
	private Supplier<Map<String, ColorPaletteValue>> _value_i18nSupplier;
	...
	public String toString() {
		...
		ColorPaletteValue value = getValue();
		...
		Map<String, ColorPaletteValue> value_i18n = getValue_i18n();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.ColorPaletteFragmentConfigurationFieldValue",
		name = "x-class-name"
	)
