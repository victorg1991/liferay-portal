...
public class NavigationMenuFragmentConfigurationFieldValue
	...
	public static NavigationMenuFragmentConfigurationFieldValue toDTO(
		...
		return ObjectMapperUtil.readValue(
			NavigationMenuFragmentConfigurationFieldValue.class, json);
	}

	public static NavigationMenuFragmentConfigurationFieldValue unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the fragment configuration field of type navigation menu."
	)
	@Valid
	...
	@JsonIgnore
	private Supplier<NavigationMenuValue> _valueSupplier;

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the fragment configuration field of type navigation menu."
	)
	@Valid
	...
	@JsonIgnore
	private Supplier<Map<String, NavigationMenuValue>> _value_i18nSupplier;
	...
	public String toString() {
		...
		NavigationMenuValue value = getValue();
		...
		Map<String, NavigationMenuValue> value_i18n = getValue_i18n();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.NavigationMenuFragmentConfigurationFieldValue",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-923311138