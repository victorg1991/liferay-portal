...
@Generated("")
@GraphQLName(
	description = "A unique reference to a repeatable fields collection which remains constant across environments.",
	value = "RepeatableFieldsCollectionProviderReference"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "A unique reference to a repeatable fields collection which remains constant across environments.",
	requiredProperties = {"className", "fieldName"}
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "RepeatableFieldsCollectionProviderReference")
public class RepeatableFieldsCollectionProviderReference
	...
	public static RepeatableFieldsCollectionProviderReference toDTO(
		...
		return ObjectMapperUtil.readValue(
			RepeatableFieldsCollectionProviderReference.class, json);
	}

	public static RepeatableFieldsCollectionProviderReference unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.RepeatableFieldsCollectionProviderReference",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-921415644