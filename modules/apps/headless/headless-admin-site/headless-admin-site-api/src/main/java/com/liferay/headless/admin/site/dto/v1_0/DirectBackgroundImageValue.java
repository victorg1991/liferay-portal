...
public class DirectBackgroundImageValue
	extends BackgroundImageValue implements Serializable {

	public static DirectBackgroundImageValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			DirectBackgroundImageValue.class, json);
	}

	public static DirectBackgroundImageValue unsafeToDTO(String json) {
	...
	public ImageValue getImageValue() {
		if (_imageValueSupplier != null) {
			imageValue = _imageValueSupplier.get();

			_imageValueSupplier = null;
		}
	...
	public void setImageValue(
		...
		_imageValueSupplier = () -> {
			try {
				return imageValueUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<ImageValue> _imageValueSupplier;
	...
	public String toString() {
		...
		if (imageValue != null) {
			...
			sb.append(String.valueOf(imageValue));
		}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.DirectBackgroundImageValue",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-447719525