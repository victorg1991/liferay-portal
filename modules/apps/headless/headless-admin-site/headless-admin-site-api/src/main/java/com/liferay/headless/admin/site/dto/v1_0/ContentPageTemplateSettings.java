...
public class ContentPageTemplateSettings
	...
	public static ContentPageTemplateSettings toDTO(String json) {
		return ObjectMapperUtil.readValue(
			ContentPageTemplateSettings.class, json);
	}

	public static ContentPageTemplateSettings unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.ContentPageTemplateSettings",
		name = "x-class-name"
	)
