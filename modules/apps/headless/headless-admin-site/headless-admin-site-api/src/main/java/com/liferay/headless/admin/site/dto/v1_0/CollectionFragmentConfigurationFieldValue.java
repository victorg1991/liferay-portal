...
@Generated("")
@GraphQLName(
	description = "The value of a fragment configuration field of type collection.",
	value = "CollectionFragmentConfigurationFieldValue"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "The value of a fragment configuration field of type collection."
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "CollectionFragmentConfigurationFieldValue")
public class CollectionFragmentConfigurationFieldValue
	...
	public static CollectionFragmentConfigurationFieldValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			CollectionFragmentConfigurationFieldValue.class, json);
	}

	public static CollectionFragmentConfigurationFieldValue unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the fragment configuration field of type collection."
	)
	@Valid
	...
	@JsonIgnore
	private Supplier<CollectionReference> _valueSupplier;

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the fragment configuration field of type collection."
	)
	@Valid
	...
	@JsonIgnore
	private Supplier<Map<String, CollectionReference>> _value_i18nSupplier;
	...
	public String toString() {
		...
		CollectionReference value = getValue();
		...
		Map<String, CollectionReference> value_i18n = getValue_i18n();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.CollectionFragmentConfigurationFieldValue",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:216193419