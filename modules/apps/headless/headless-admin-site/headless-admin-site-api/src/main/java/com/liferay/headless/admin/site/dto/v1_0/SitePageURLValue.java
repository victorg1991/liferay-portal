 ...
 */
@Generated("")
@GraphQLName("SitePageURLValue")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "SitePageURLValue")
public class SitePageURLValue extends URLValue implements Serializable {

	public static SitePageURLValue toDTO(String json) {
		return ObjectMapperUtil.readValue(SitePageURLValue.class, json);
	}

	public static SitePageURLValue unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(SitePageURLValue.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.SitePageURLValue",
		name = "x-class-name"
	)
