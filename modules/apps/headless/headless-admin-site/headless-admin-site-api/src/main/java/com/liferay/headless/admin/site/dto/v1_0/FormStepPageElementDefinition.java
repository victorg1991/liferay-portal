...
@Generated("")
@GraphQLName(
	description = "The page element definition of a form step.",
	value = "FormStepPageElementDefinition"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "The page element definition of a form step."
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "FormStepPageElementDefinition")
public class FormStepPageElementDefinition
	...
	public static FormStepPageElementDefinition unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.FormStepPageElementDefinition",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:976195784