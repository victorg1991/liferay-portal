...
public class ClassSubtypeReference implements Serializable {
	...
	public static ClassSubtypeReference toDTO(String json) {
		return ObjectMapperUtil.readValue(ClassSubtypeReference.class, json);
	}

	public static ClassSubtypeReference unsafeToDTO(String json) {
...
// LIFERAY-REST-BUILDER-HASH:494393807