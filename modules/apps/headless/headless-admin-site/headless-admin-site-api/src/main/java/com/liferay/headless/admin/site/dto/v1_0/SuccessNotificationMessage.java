...
public class SuccessNotificationMessage implements Serializable {
	...
	public static SuccessNotificationMessage toDTO(String json) {
		return ObjectMapperUtil.readValue(
			SuccessNotificationMessage.class, json);
	}

	public static SuccessNotificationMessage unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			SuccessNotificationMessage.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized success notification message."
	)
	@Valid
	...
	@GraphQLField(description = "The localized success notification message.")
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.SuccessNotificationMessage",
		name = "x-class-name"
	)
