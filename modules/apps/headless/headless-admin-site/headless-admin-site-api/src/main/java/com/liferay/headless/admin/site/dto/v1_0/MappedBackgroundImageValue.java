...
public class MappedBackgroundImageValue
	...
	public static MappedBackgroundImageValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			MappedBackgroundImageValue.class, json);
	}

	public static MappedBackgroundImageValue unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.MappedBackgroundImageValue",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1312364585