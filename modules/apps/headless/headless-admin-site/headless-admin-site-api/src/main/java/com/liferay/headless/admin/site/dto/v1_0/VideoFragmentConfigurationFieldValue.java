...
public class VideoFragmentConfigurationFieldValue
	...
	public static VideoFragmentConfigurationFieldValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			VideoFragmentConfigurationFieldValue.class, json);
	}

	public static VideoFragmentConfigurationFieldValue unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the fragment configuration field of type video."
	)
	@Valid
	...
	@JsonIgnore
	private Supplier<VideoValue> _valueSupplier;

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the fragment configuration field of type video."
	)
	@Valid
	...
	@JsonIgnore
	private Supplier<Map<String, VideoValue>> _value_i18nSupplier;
	...
	public String toString() {
		...
		Map<String, VideoValue> value_i18n = getValue_i18n();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.VideoFragmentConfigurationFieldValue",
		name = "x-class-name"
	)
