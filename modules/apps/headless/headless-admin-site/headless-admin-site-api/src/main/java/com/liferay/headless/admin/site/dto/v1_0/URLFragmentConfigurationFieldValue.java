...
@Generated("")
@GraphQLName(
	description = "The value of a fragment configuration field of type URL.",
	value = "URLFragmentConfigurationFieldValue"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "The value of a fragment configuration field of type URL."
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "URLFragmentConfigurationFieldValue")
public class URLFragmentConfigurationFieldValue
	...
	public static URLFragmentConfigurationFieldValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			URLFragmentConfigurationFieldValue.class, json);
	}

	public static URLFragmentConfigurationFieldValue unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			URLFragmentConfigurationFieldValue.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the fragment configuration field of type URL."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the fragment configuration field of type URL."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.URLFragmentConfigurationFieldValue",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1429105308