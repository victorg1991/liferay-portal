 ...
 */
@Generated("")
@GraphQLName(description = "A page template set.", value = "PageTemplateSet")
@io.swagger.v3.oas.annotations.media.Schema(
	description = "A page template set."
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "PageTemplateSet")
public class PageTemplateSet implements Serializable {

	public static PageTemplateSet toDTO(String json) {
		return ObjectMapperUtil.readValue(PageTemplateSet.class, json);
	}

	public static PageTemplateSet unsafeToDTO(String json) {
	...
	@GraphQLField(description = "The page template set's creation date.")
	...
	@GraphQLField(description = "The last time the page template set changed.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "The page template set's description.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "The page template set's key.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "The page template set's name.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof PageTemplateSet)) {
			return false;
		}

		PageTemplateSet pageTemplateSet = (PageTemplateSet)object;

		return Objects.equals(toString(), pageTemplateSet.toString());
	}
...
// LIFERAY-REST-BUILDER-HASH:1516527445