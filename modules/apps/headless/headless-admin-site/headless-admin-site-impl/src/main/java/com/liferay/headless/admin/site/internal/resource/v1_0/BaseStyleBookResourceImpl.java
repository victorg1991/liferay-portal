...
public abstract class BaseStyleBookResourceImpl
	implements EntityModelResource, StyleBookResource,
			   VulcanBatchEngineTaskItemDelegate<StyleBook> {
	...
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			...
			@io.swagger.v3.oas.annotations.Parameter(
				in = io.swagger.v3.oas.annotations.enums.ParameterIn.PATH,
				name = "styleBookExternalReferenceCode"
			)
		}
	)
	...
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/style-books/{styleBookExternalReferenceCode}"
	)
	...
	public void deleteSiteStyleBook(
			...
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("styleBookExternalReferenceCode")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sites/{siteExternalReferenceCode}/style-books")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	public StyleBook patchSiteStyleBook(
		...
		if (styleBook.getDateModified() != null) {
			existingStyleBook.setDateModified(styleBook.getDateModified());
		}

		if (styleBook.getDefaultStyleBook() != null) {
			existingStyleBook.setDefaultStyleBook(
				styleBook.getDefaultStyleBook());
		}

		if (styleBook.getExternalReferenceCode() != null) {
			existingStyleBook.setExternalReferenceCode(
				styleBook.getExternalReferenceCode());
		}

		if (styleBook.getFrontendTokensValues() != null) {
			existingStyleBook.setFrontendTokensValues(
				styleBook.getFrontendTokensValues());
		}

		if (styleBook.getKey() != null) {
			existingStyleBook.setKey(styleBook.getKey());
		}
		...
		preparePatch(styleBook, existingStyleBook);

		return putSiteStyleBook(
			siteExternalReferenceCode, styleBookExternalReferenceCode,
			existingStyleBook);
	}
	...
	@jakarta.ws.rs.Path("/sites/{siteExternalReferenceCode}/style-books/batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	public Response postSiteStyleBookBatch(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("siteExternalReferenceCode")
			String siteExternalReferenceCode,
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				StyleBook.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/style-books/export-batch"
	)
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	public Response postSiteStyleBooksPageExportBatch(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("siteExternalReferenceCode")
			String siteExternalReferenceCode,
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				StyleBook.class.getName(), callbackURL, contentType, fieldNames)
		).build();
	}
	...
	public void create(
			Collection<StyleBook> styleBooks,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<StyleBook, StyleBook, Exception>
			styleBookUnsafeFunction = null;
		...
		if (StringUtil.equalsIgnoreCase(createStrategy, "UPSERT")) {
			...
			if (StringUtil.equalsIgnoreCase(updateStrategy, "UPDATE")) {
				styleBookUnsafeFunction = styleBook -> {
					StyleBook persistedStyleBook = null;

					if (parameters.containsKey("siteExternalReferenceCode")) {
						persistedStyleBook = putSiteStyleBook(
							(String)parameters.get("siteExternalReferenceCode"),
							styleBook.getExternalReferenceCode(), styleBook);
					}
					else {
						throw new NotSupportedException(
							"One of the following parameters must be specified: [siteExternalReferenceCode]");
					...
					return persistedStyleBook;
				};
			}
		}

		if (styleBookUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for StyleBook");
		}

		if (contextBatchUnsafeBiConsumer != null) {
			contextBatchUnsafeBiConsumer.accept(
				styleBooks, styleBookUnsafeFunction);
		}
		else if (contextBatchUnsafeConsumer != null) {
			contextBatchUnsafeConsumer.accept(
				styleBooks, styleBookUnsafeFunction::apply);
		}
		else {
			for (StyleBook styleBook : styleBooks) {
				styleBookUnsafeFunction.apply(styleBook);
			}
		}
	}
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<StyleBook>,
			 UnsafeFunction<StyleBook, StyleBook, Exception>, Exception>
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<StyleBook>, UnsafeConsumer<StyleBook, Exception>,
	...
	protected void preparePatch(
		StyleBook styleBook, StyleBook existingStyleBook) {
	}
	...
	protected UnsafeBiConsumer
		<Collection<StyleBook>, UnsafeFunction<StyleBook, StyleBook, Exception>,
		 Exception> contextBatchUnsafeBiConsumer;
	protected UnsafeBiConsumer
		<Collection<StyleBook>, UnsafeConsumer<StyleBook, Exception>, Exception>
...
// LIFERAY-REST-BUILDER-HASH:1538782466