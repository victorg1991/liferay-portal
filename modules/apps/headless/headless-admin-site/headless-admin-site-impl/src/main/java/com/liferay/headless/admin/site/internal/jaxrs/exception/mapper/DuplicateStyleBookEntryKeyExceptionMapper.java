...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.Site.DuplicateStyleBookEntryKeyExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class DuplicateStyleBookEntryKeyExceptionMapper
	extends BaseExceptionMapper<DuplicateStyleBookEntryKeyException> {
