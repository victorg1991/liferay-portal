...
public abstract class BasePageSpecificationResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PATCH' 'http://localhost:8080/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/page-specifications/{pageSpecificationExternalReferenceCode}' -d $'{"customFields": ___, "externalReferenceCode": ___, "status": ___, "type": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	...
	public PageSpecification patchSitePageSpecification(
		...
		PageSpecification existingPageSpecification = getSitePageSpecification(
			siteExternalReferenceCode, pageSpecificationExternalReferenceCode);

		if (pageSpecification.getCustomFields() != null) {
			existingPageSpecification.setCustomFields(
		...
		return putSitePageSpecification(
			siteExternalReferenceCode, pageSpecificationExternalReferenceCode,
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/page-specifications/{pageSpecificationExternalReferenceCode}' -d $'{"customFields": ___, "externalReferenceCode": ___, "status": ___, "type": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	...
	public void create(
			Collection<PageSpecification> pageSpecifications,
	...
	@Override
	public Page<PageSpecification> read(
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<PageSpecification>,
			 UnsafeConsumer<PageSpecification, Exception>, Exception>
