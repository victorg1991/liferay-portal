...
public interface AggregateRatingResource {
	...
	@GET
	@Path("/aggregate-ratings/{aggregate-ratings-id}")
	@Produces("application/json")
	@RequiresScope("everything.read")
	public AggregateRating getAggregateRating( @PathParam("aggregate-ratings-id") Long aggregateRatingsId ) throws Exception;
