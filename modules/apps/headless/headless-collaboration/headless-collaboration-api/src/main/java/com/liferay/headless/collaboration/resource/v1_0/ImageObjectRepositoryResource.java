...
public interface ImageObjectRepositoryResource {
	...
	@GET
	@Path("/image-object-repositories/{image-object-repositories-id}")
	@Produces("application/json")
	@RequiresScope("everything.read")
	public ImageObjectRepository getImageObjectRepositories( @PathParam("image-object-repositories-id") Long imageObjectRepositoriesId ) throws Exception;
