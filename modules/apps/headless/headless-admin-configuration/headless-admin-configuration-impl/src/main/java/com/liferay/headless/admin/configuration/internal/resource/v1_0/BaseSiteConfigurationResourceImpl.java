...
public abstract class BaseSiteConfigurationResourceImpl
	implements EntityModelResource, SiteConfigurationResource,
			   VulcanBatchEngineTaskItemDelegate<SiteConfiguration> {
	...
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			...
			@io.swagger.v3.oas.annotations.Parameter(
				in = io.swagger.v3.oas.annotations.enums.ParameterIn.PATH,
				name = "siteConfigurationExternalReferenceCode"
			)
		}
	)
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/site-configurations"
	)
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/site-configurations/batch"
	)
	@jakarta.ws.rs.POST
	...
	public Response postSiteSiteConfigurationBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				SiteConfiguration.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/site-configurations/export-batch"
	)
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	public Response postSiteSiteConfigurationsPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				SiteConfiguration.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
	...
	public void create(
		...
		UnsafeFunction<SiteConfiguration, SiteConfiguration, Exception>
			siteConfigurationUnsafeFunction = null;
		...
		if (StringUtil.equalsIgnoreCase(createStrategy, "UPSERT")) {
			...
			if (StringUtil.equalsIgnoreCase(updateStrategy, "UPDATE")) {
				siteConfigurationUnsafeFunction = siteConfiguration -> {
					SiteConfiguration persistedSiteConfiguration = null;

					if (parameters.containsKey("siteExternalReferenceCode")) {
						persistedSiteConfiguration = putSiteSiteConfiguration(
							(String)parameters.get("siteExternalReferenceCode"),
					...
					return persistedSiteConfiguration;
				};
			}
		}

		if (siteConfigurationUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for SiteConfiguration");
		}

		if (contextBatchUnsafeBiConsumer != null) {
			contextBatchUnsafeBiConsumer.accept(
				siteConfigurations, siteConfigurationUnsafeFunction);
		}
		else if (contextBatchUnsafeConsumer != null) {
			contextBatchUnsafeConsumer.accept(
				siteConfigurations, siteConfigurationUnsafeFunction::apply);
		}
		else {
			for (SiteConfiguration siteConfiguration : siteConfigurations) {
				siteConfigurationUnsafeFunction.apply(siteConfiguration);
			}
		}
	}
	...
	@Override
	public Page<SiteConfiguration> read(
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<SiteConfiguration>,
			 UnsafeConsumer<SiteConfiguration, Exception>, Exception>
