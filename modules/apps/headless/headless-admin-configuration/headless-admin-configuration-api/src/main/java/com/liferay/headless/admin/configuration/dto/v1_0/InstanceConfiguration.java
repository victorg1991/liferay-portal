...
package com.liferay.headless.admin.configuration.dto.v1_0;
 ...
 */
@Generated("")
@GraphQLName("InstanceConfiguration")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "InstanceConfiguration")
public class InstanceConfiguration implements Serializable {

	public static InstanceConfiguration toDTO(String json) {
		return ObjectMapperUtil.readValue(InstanceConfiguration.class, json);
	}

	public static InstanceConfiguration unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			InstanceConfiguration.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.configuration.dto.v1_0.InstanceConfiguration",
		name = "x-class-name"
	)
