...
public class TaxonomyCategoryBulkActionSerDes {
	...
	public static String toJSON(
		...
		if (taxonomyCategoryBulkAction.getTaxonomyCategoryIdsToRemove() !=
				null) {
		...
		if (taxonomyCategoryBulkAction.getSelectionScope() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(
				String.valueOf(taxonomyCategoryBulkAction.getSelectionScope()));
		}
	...
	public static class TaxonomyCategoryBulkActionJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "append")) {
				...
				if (jsonParserFieldValue != null) {
					taxonomyCategoryBulkAction.setTaxonomyCategoryIdsToRemove(
						toLongs((Object[])jsonParserFieldValue));
				}
			}
			else if (Objects.equals(jsonParserFieldName, "bulkActionItems")) {
				...
				if (jsonParserFieldValue != null) {
					taxonomyCategoryBulkAction.setSelectionScope(
