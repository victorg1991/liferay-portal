...
@Component(
	...
	property = {
		...
		"mvc.command.name=/frontend_icons_admin/delete_icon_pack"
	},
	service = MVCActionCommand.class
)
public class DeleteIconPackMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		_iconResourceHelper.deleteIconResourcePack(
