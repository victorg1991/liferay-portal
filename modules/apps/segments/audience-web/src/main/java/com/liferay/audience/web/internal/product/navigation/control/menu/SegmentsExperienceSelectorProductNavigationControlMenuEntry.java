...
package com.liferay.audience.web.internal.product.navigation.control.menu;

import com.liferay.audience.web.internal.display.context.SegmentsExperienceSelectorDisplayContext;
	...
	public boolean includeIcon(
		...
		try {
			...
			_reactRenderer.renderReact(
				new ComponentDescriptor("{ExperiencePicker} from audience-web"),
