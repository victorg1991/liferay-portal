...
import com.liferay.audience.web.internal.util.comparator.SegmentsEntryModifiedDateComparator;
import com.liferay.audience.web.internal.util.comparator.SegmentsEntryNameComparator;
...
public class SegmentsDisplayContext {
	...
	public String getDisplayStyle() {
		...
		_displayStyle = SearchDisplayStyleUtil.getDisplayStyle(
			_renderRequest, AudiencePortletKeys.AUDIENCE, "list");
	...
	public String getOrderByType() {
		...
		_orderByType = SearchOrderByUtil.getOrderByType(
			_renderRequest, AudiencePortletKeys.AUDIENCE, "asc");
	...
	private String _getOrderByCol() {
		...
		_orderByCol = SearchOrderByUtil.getOrderByCol(
			_renderRequest, AudiencePortletKeys.AUDIENCE, "modified-date");
