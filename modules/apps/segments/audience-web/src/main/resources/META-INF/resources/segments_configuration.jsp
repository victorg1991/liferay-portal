...
<liferay-util:html-top
	outputKey="com.liferay.audience.web#/segments_configuration.jsp"
>
	<aui:link hashedFile="<%= true %>" href="audience-web/css/configuration.css" rel="stylesheet" type="text/css" />
</liferay-util:html-top>
...
<liferay-frontend:component
	module="{ConfigurationFormEventHandler} from audience-web"
/>