...
/**
 * Provides the local service interface for SegmentsExperienceAudienceEntryRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Eduardo Garcia
 * @see SegmentsExperienceAudienceEntryRelLocalServiceUtil
 * @generated
 */
@CTAware
@ProviderType
...
public interface SegmentsExperienceAudienceEntryRelLocalService
	extends BaseLocalService, CTService<SegmentsExperienceAudienceEntryRel>,
			PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.segments.service.impl.SegmentsExperienceAudienceEntryRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the segments experience audience entry rel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SegmentsExperienceAudienceEntryRelLocalServiceUtil} if injection and service tracking are not available.
	 */
