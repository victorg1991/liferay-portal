...
public interface OAuthClientEntryPersistence
	 ...
	 */
	public java.util.List<OAuthClientEntry> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<OAuthClientEntry> findByUuid(
	 ...
	 */
	public java.util.List<OAuthClientEntry> filterFindByUuid(String uuid);
	 ...
	 */
	public java.util.List<OAuthClientEntry> filterFindByUuid(
		String uuid, int start, int end);
	 ...
	 * @return the matching o auth client entries
	 */
	public java.util.List<OAuthClientEntry> findByUuid_C(
	 ...
	 * @return the matching o auth client entries that the user has permission to view
	 */
	public java.util.List<OAuthClientEntry> filterFindByUuid_C(
		String uuid, long companyId);
...
// LIFERAY-SERVICE-BUILDER-HASH:2009665842