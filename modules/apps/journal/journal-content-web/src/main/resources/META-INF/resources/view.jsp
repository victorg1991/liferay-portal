			...
			<c:when test="<%= Validator.isNotNull(journalContentDisplayContext.getArticleId()) %>">
				<c:choose>
					...
					<c:when test="<%= articleDisplay != null %>">
						...
						<div class="<%= journalContentDisplayContext.isPreview() ? "p-1 preview-asset-entry" : StringPool.BLANK %>" data-fragments-editor-item-id="classNameId-<%= assetRenderer.getClassPK() %>" data-fragments-editor-item-type="fragments-editor-mapped-item">
