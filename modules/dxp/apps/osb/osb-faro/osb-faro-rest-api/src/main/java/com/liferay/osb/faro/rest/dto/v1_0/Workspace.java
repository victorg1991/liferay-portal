...
public class Workspace implements Serializable {
	...
	public static Workspace toDTO(String json) {
		return ObjectMapperUtil.readValue(Workspace.class, json);
	}

	public static Workspace unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Workspace.class, json);
	}
	...
	@GraphQLField(description = "Display name of the workspace.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.osb.faro.rest.dto.v1_0.Workspace",
		name = "x-class-name"
	)
