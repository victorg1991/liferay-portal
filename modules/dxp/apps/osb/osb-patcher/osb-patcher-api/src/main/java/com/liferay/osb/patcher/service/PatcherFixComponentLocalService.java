...
/**
 * Provides the local service interface for PatcherFixComponent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PatcherFixComponentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PatcherFixComponentLocalService
...
// LIFERAY-SERVICE-BUILDER-HASH:-116236762