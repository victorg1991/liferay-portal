...
public class Model implements Serializable {
	...
	public String getProviderLabel() {
		if (_providerLabelSupplier != null) {
			providerLabel = _providerLabelSupplier.get();

			_providerLabelSupplier = null;
		}
	...
	public void setProviderLabel(
		...
		_providerLabelSupplier = () -> {
			try {
				return providerLabelUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<String> _providerLabelSupplier;
	...
	public String toString() {
		...
		if (providerLabel != null) {
			...
			sb.append(_escape(providerLabel));
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.ai.hub.rest.dto.v1_0.Model",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-838589133