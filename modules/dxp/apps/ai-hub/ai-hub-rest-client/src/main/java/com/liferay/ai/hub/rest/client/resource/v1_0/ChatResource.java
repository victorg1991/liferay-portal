...
public interface ChatResource {
	...
	public HttpInvoker.HttpResponse getChatSubscribeHttpResponse(
	...
	public static class Builder {
		...
		public ChatResource build() {
			return new ChatResourceImpl(this);
		}
	...
	public static class ChatResourceImpl implements ChatResource {

		public void getChatSubscribe(
				jakarta.ws.rs.sse.SseEventSink sseEventSink)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getChatSubscribeHttpResponse(sseEventSink);
		...
		private ChatResourceImpl(Builder builder) {
			_builder = builder;
		}
