...
public class AuthenticationScheme implements Serializable {
	...
	public static AuthenticationScheme toDTO(String json) {
		return ObjectMapperUtil.readValue(AuthenticationScheme.class, json);
	}

	public static AuthenticationScheme unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			AuthenticationScheme.class, json);
	}
	...
	public String getSpecUri() {
		if (_specUriSupplier != null) {
			specUri = _specUriSupplier.get();

			_specUriSupplier = null;
		}
	...
	public void setSpecUri(
		...
		_specUriSupplier = () -> {
			try {
				return specUriUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<String> _specUriSupplier;
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.scim.rest.dto.v1_0.AuthenticationScheme",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:2136419614