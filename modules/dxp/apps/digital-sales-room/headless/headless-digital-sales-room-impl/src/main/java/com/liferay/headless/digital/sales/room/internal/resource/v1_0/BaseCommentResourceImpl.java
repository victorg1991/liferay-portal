...
public abstract class BaseCommentResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-digital-sales-room/v1.0/digital-sales-rooms/{digitalSalesRoomId}/comments'  -u 'test@liferay.com:test'
	 */
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/digital-sales-rooms/{digitalSalesRoomId}/comments")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-digital-sales-room/v1.0/digital-sales-rooms/{digitalSalesRoomId}/comments' -d $'{"category": ___, "parentCommentId": ___, "text": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
