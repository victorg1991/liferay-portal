...
public abstract class BaseDigitalSalesRoomTemplateResourceImpl
	implements DigitalSalesRoomTemplateResource,
			   VulcanCRUDItemDelegate<DigitalSalesRoomTemplate> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-digital-sales-room/v1.0/digital-sales-room-templates/{digitalSalesRoomTemplateId}'  -u 'test@liferay.com:test'
	 */
	...
	@Override
	public void deleteDigitalSalesRoomTemplate(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-digital-sales-room/v1.0/digital-sales-rooms/{digitalSalesRoomId}/digital-sales-room-templates'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path(
		"/digital-sales-rooms/{digitalSalesRoomId}/digital-sales-room-templates"
	)
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-digital-sales-room/v1.0/digital-sales-room-templates/{digitalSalesRoomTemplateId}'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/digital-sales-room-templates")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-digital-sales-room/v1.0/digital-sales-room-templates' -d $'{"banner": ___, "clientLogo": ___, "clientName": ___, "description": ___, "name": ___, "primaryColor": ___, "secondaryColor": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
	...
	@Override
	public DigitalSalesRoomTemplate getItem(Long id) throws Exception {
		return getDigitalSalesRoomTemplate(id);
	}
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseDigitalSalesRoomTemplateResourceImpl.class);
