...
public interface RSVEntryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.revert.schema.version.service.impl.RSVEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the rsv entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RSVEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
