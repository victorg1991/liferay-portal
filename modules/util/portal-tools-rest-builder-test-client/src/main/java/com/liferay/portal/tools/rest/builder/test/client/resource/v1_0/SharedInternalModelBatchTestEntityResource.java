 ...
 */
@Generated("")
public interface SharedInternalModelBatchTestEntityResource {
	...
	public HttpInvoker.HttpResponse
			getSharedInternalModelBatchTestEntitiesPageHttpResponse()
		throws Exception;
	...
	public void postSharedInternalModelBatchTestEntitiesPageExportBatch(
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postSharedInternalModelBatchTestEntitiesPageExportBatchHttpResponse(
				String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postSharedInternalModelBatchTestEntityHttpResponse(
				SharedInternalModelBatchTestEntity
					sharedInternalModelBatchTestEntity)
		throws Exception;

	public void postSharedInternalModelBatchTestEntityBatch(
			String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse
			postSharedInternalModelBatchTestEntityBatchHttpResponse(
				String callbackURL, Object object)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putSharedInternalModelBatchTestEntityByExternalReferenceCodeHttpResponse(
				String externalReferenceCode,
				SharedInternalModelBatchTestEntity
					sharedInternalModelBatchTestEntity)
		throws Exception;
	...
	public static class Builder {
		...
		public SharedInternalModelBatchTestEntityResource build() {
			return new SharedInternalModelBatchTestEntityResourceImpl(this);
		}
	...
	public static class SharedInternalModelBatchTestEntityResourceImpl
		implements SharedInternalModelBatchTestEntityResource {
		...
		public Page<SharedInternalModelBatchTestEntity>
			...
			try {
				return Page.of(
					content, SharedInternalModelBatchTestEntitySerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public SharedInternalModelBatchTestEntity
			...
			try {
				return SharedInternalModelBatchTestEntitySerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				sharedInternalModelBatchTestEntity.toString(),
				"application/json");
		...
		public SharedInternalModelBatchTestEntity
			...
			HttpInvoker.HttpResponse httpResponse =
				putSharedInternalModelBatchTestEntityByExternalReferenceCodeHttpResponse(
					externalReferenceCode, sharedInternalModelBatchTestEntity);
		...
		private SharedInternalModelBatchTestEntityResourceImpl(
			Builder builder) {
		...
		private static final Logger _logger = Logger.getLogger(
			SharedInternalModelBatchTestEntityResource.class.getName());
