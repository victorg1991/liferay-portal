...
public interface MultipartTestEntityResource {
	...
	public void getSiteMultipartTestEntity(String siteExternalReferenceCode)
		throws Exception;

	public HttpInvoker.HttpResponse getSiteMultipartTestEntityHttpResponse(
	...
	public HttpInvoker.HttpResponse postMultipartTestEntityHttpResponse(
			MultipartTestEntity multipartTestEntity)
		throws Exception;

	public MultipartTestEntity postFormDataMultipartTestEntity(
			MultipartTestEntity multipartTestEntity,
			Map<String, File> multipartFiles)
		throws Exception;

	public HttpInvoker.HttpResponse postFormDataMultipartTestEntityHttpResponse(
			MultipartTestEntity multipartTestEntity,
			Map<String, File> multipartFiles)
		throws Exception;

	public void postMultipartTestEntityBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postMultipartTestEntityBatchHttpResponse(
	...
	public HttpInvoker.HttpResponse putSiteMultipartTestEntityHttpResponse(
			String siteExternalReferenceCode,
			MultipartTestEntity multipartTestEntity,
			Map<String, File> multipartFiles)
		throws Exception;
	...
	public static class MultipartTestEntityResourceImpl
		...
		public void getSiteMultipartTestEntity(String siteExternalReferenceCode)
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteMultipartTestEntityHttpResponse(
		...
		public MultipartTestEntity postMultipartTestEntity(
			...
			HttpInvoker.HttpResponse httpResponse =
				postMultipartTestEntityHttpResponse(multipartTestEntity);
		...
		public MultipartTestEntity postFormDataMultipartTestEntity(
			...
			HttpInvoker.HttpResponse httpResponse =
				postFormDataMultipartTestEntityHttpResponse(
					multipartTestEntity, multipartFiles);
		...
		public void postMultipartTestEntityBatch(
				String callbackURL, Object object)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				postMultipartTestEntityBatchHttpResponse(callbackURL, object);
		...
		public HttpInvoker.HttpResponse
				postMultipartTestEntityBatchHttpResponse(
					String callbackURL, Object object)
			throws Exception {
		...
		public MultipartTestEntity putSiteMultipartTestEntity(
			...
			HttpInvoker.HttpResponse httpResponse =
				putSiteMultipartTestEntityHttpResponse(
					siteExternalReferenceCode, multipartTestEntity,
					multipartFiles);
