...
@XmlRootElement(name = "SharedInternalModelBatchTestEntity")
public class SharedInternalModelBatchTestEntity implements Serializable {

	public static SharedInternalModelBatchTestEntity toDTO(String json) {
		return ObjectMapperUtil.readValue(
			SharedInternalModelBatchTestEntity.class, json);
	}

	public static SharedInternalModelBatchTestEntity unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.portal.tools.rest.builder.test.dto.v1_0.SharedInternalModelBatchTestEntity",
		name = "x-class-name"
	)
