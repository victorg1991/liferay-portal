...
import com.liferay.portal.tools.rest.builder.test.client.resource.v1_0.SchemaResource;
...
public abstract class BaseSchemaResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		Assert.assertEquals(regex, schema.getProperty1());
	}

	@Test
	public void testGetSchemasPage() throws Exception {
		Page<Schema> page = schemaResource.getSchemasPage();

		long totalCount = page.getTotalCount();

		Schema schema1 = testGetSchemasPage_addSchema(randomSchema());

		Schema schema2 = testGetSchemasPage_addSchema(randomSchema());

		page = schemaResource.getSchemasPage();

		Assert.assertEquals(totalCount + 2, page.getTotalCount());

		assertContains(schema1, (List<Schema>)page.getItems());
		assertContains(schema2, (List<Schema>)page.getItems());
		assertValid(page, testGetSchemasPage_getExpectedActions());
	}

	protected Map<String, Map<String, String>>
			testGetSchemasPage_getExpectedActions()
		throws Exception {
	...
	protected Schema testGetSchemasPage_addSchema(Schema schema)
		throws Exception {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.portal.tools.rest.builder.test.dto.v1_0.Schema.
						class)) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("property1", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						schema1.getProperty1(), schema2.getProperty1())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("property1")) {
			Object object = schema.getProperty1();
	...
	@Inject
	private
		com.liferay.portal.tools.rest.builder.test.resource.v1_0.SchemaResource
			_schemaResource;

}
// LIFERAY-REST-BUILDER-HASH:1939042529