...
@OSGiBeanProperties(
	property = {
		"model.class.name=com.liferay.portal.tools.service.builder.test.model.CacheDisabledEntry"
	}
)
@ProviderType
@Transactional(
...
// LIFERAY-SERVICE-BUILDER-HASH:-1540109442