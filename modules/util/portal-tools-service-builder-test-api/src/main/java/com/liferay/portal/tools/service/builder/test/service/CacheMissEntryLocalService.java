...
/**
 * Provides the local service interface for CacheMissEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CacheMissEntryLocalServiceUtil
 * @generated
 */
@CTAware
@OSGiBeanProperties(
	property = {
		"model.class.name=com.liferay.portal.tools.service.builder.test.model.CacheMissEntry"
	}
)
@ProviderType
@Transactional(
...
public interface CacheMissEntryLocalService
	extends BaseLocalService, CTService<CacheMissEntry>,
			PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.service.impl.CacheMissEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cache miss entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CacheMissEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
