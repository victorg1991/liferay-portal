...
public interface MappingEntryPersistence extends BasePersistence<MappingEntry> {
	 ...
	 */
	public java.util.List<MappingEntry> getBasicEntryMappingEntries(long pk);
	 ...
	 */
	public java.util.List<MappingEntry> getBasicEntryMappingEntries(
	 ...
	 * @return <code>true</code> if at least one association between the mapping entry and the basic entries was added; <code>false</code> if they were all already associated
	 */
	public boolean addBasicEntries(
		long pk,
		java.util.List
