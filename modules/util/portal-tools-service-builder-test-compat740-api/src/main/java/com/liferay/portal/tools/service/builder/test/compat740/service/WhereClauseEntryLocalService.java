...
public interface WhereClauseEntryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.compat740.service.impl.WhereClauseEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the where clause entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link WhereClauseEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
...
// LIFERAY-SERVICE-BUILDER-HASH:1586080005