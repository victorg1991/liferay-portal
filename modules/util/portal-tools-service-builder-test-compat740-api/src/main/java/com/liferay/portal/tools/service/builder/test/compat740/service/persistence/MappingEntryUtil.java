...
/**
 * The persistence utility for the mapping entry service. This utility wraps <code>com.liferay.portal.tools.service.builder.test.compat740.service.persistence.impl.MappingEntryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class MappingEntryUtil {
	 ...
	 */
	public static List<MappingEntry> getBasicEntryMappingEntries(long pk) {
		return getPersistence().getBasicEntryMappingEntries(pk);
	}
	...
	public static List<MappingEntry> getBasicEntryMappingEntries(
		...
		return getPersistence().getBasicEntryMappingEntries(pk, start, end);
	}
	...
	public static List<MappingEntry> getBasicEntryMappingEntries(
		...
		return getPersistence().getBasicEntryMappingEntries(
	 ...
	 */
	public static boolean addBasicEntry(long pk, long basicEntryPK) {
		return getPersistence().addBasicEntry(pk, basicEntryPK);
	}
	 ...
	 * @return <code>true</code> if an association between the mapping entry and the basic entry was added; <code>false</code> if they were already associated
	 */
	public static boolean addBasicEntry(
		long pk,
		com.liferay.portal.tools.service.builder.test.compat740.model.BasicEntry
			basicEntry) {

		return getPersistence().addBasicEntry(pk, basicEntry);
	}
	 ...
	 */
	public static boolean addBasicEntries(long pk, long[] basicEntryPKs) {
		return getPersistence().addBasicEntries(pk, basicEntryPKs);
	}
	 ...
	 * @return <code>true</code> if at least one association between the mapping entry and the basic entries was added; <code>false</code> if they were all already associated
	 */
	public static boolean addBasicEntries(
		long pk,
		List
			<com.liferay.portal.tools.service.builder.test.compat740.model.
				BasicEntry> basicEntries) {

		return getPersistence().addBasicEntries(pk, basicEntries);
	}
