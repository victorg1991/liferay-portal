 ...
 */
@Component(
	property = "resource.locator.key=/test/v1.0/SharedInternalModelBatchTestEntity",
	service = SharedInternalModelBatchTestEntityResource.Factory.class
)
@Generated("")
public class SharedInternalModelBatchTestEntityResourceFactoryImpl
	implements SharedInternalModelBatchTestEntityResource.Factory {

	@Override
	public SharedInternalModelBatchTestEntityResource.Builder create() {
		return new SharedInternalModelBatchTestEntityResource.Builder() {

			@Override
			public SharedInternalModelBatchTestEntityResource build() {
				if (_user == null) {
				...
				Function
					<InvocationHandler,
					 SharedInternalModelBatchTestEntityResource>
						sharedInternalModelBatchTestEntityResourceProxyProviderFunction =
							ResourceProxyProviderFunctionHolder.
								_sharedInternalModelBatchTestEntityResourceProxyProviderFunction;

				return sharedInternalModelBatchTestEntityResourceProxyProviderFunction.
					apply(
			...
			@Override
			public SharedInternalModelBatchTestEntityResource.Builder
			...
			@Override
			public SharedInternalModelBatchTestEntityResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public SharedInternalModelBatchTestEntityResource.Builder user(
				User user) {
	...
	private static Function
		<InvocationHandler, SharedInternalModelBatchTestEntityResource>
			_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			SharedInternalModelBatchTestEntityResource.class.getClassLoader(),
			SharedInternalModelBatchTestEntityResource.class);

		try {
			Constructor<SharedInternalModelBatchTestEntityResource>
				constructor =
					(Constructor<SharedInternalModelBatchTestEntityResource>)
